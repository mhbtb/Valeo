...
echo options GLOBALS_DISPLAY RANGE_ITERATION >> commands.tmp
...
echo options VCAST_PRQAC_COMPILER_SETTINGS_FILE C:/Tools/PRQA/QAC-7.1/personalities/start.p_c >> commands.tmp
echo options VCAST_PRQAC_ANALYSER_BASE C:/Tools/PRQA/QAC-7.1 >> commands.tmp
echo options VCAST_PRQAC_MESSAGE_PERSONALITY_FILE C:/Tools/PRQA/QAC-7.1\\personalities\\critical.p_s >> commands.tmp
...
echo environment build G5_TWIGHLIGHTTODARK.env >> commands.tmp
echo /E:G5_TWIGHLIGHTTODARK tools script run G5_TWIGHLIGHTTODARK.tst >> commands.tmp
echo /E:G5_TWIGHLIGHTTODARK execute batch >> commands.tmp
echo /E:G5_TWIGHLIGHTTODARK reports custom management G5_TWIGHLIGHTTODARK_management_report.html >> commands.tmp
