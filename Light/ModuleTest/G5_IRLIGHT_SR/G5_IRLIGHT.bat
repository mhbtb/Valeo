...
echo environment build G5_IRLIGHT.env >> commands.tmp
echo /E:G5_IRLIGHT tools script run G5_IRLIGHT.tst >> commands.tmp
echo /E:G5_IRLIGHT execute batch >> commands.tmp
echo /E:G5_IRLIGHT reports custom management G5_IRLIGHT_management_report.html >> commands.tmp
