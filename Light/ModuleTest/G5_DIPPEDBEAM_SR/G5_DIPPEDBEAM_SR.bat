...
echo environment build G5_DIPPEDBEAM_SR.env >> commands.tmp
echo /E:G5_DIPPEDBEAM_SR tools script run G5_DIPPEDBEAM_SR.tst >> commands.tmp
echo /E:G5_DIPPEDBEAM_SR execute batch >> commands.tmp
echo /E:G5_DIPPEDBEAM_SR reports custom management G5_DIPPEDBEAM_SR_management_report.html >> commands.tmp
