...
{
  static byte rain_light_flag = 0;
  static word time_counter_RL = 0;
  static byte enter_two = 0;
  if((rain_light_flag == 1) && (rb_WipeCounter_g >= 7))
  {
    enter_two = 1;
  }
  else
  ...
  if(rw_WipeTime_g > 200)
  {
    rw_WipeTime_g = 0;
    rb_WipeCounter_g = 0;
  }

  if(rain_light_flag == 1)
  {
    time_counter_RL++;
  }
  if(enter_two == 1)
