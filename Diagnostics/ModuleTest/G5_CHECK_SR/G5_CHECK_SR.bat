...
echo environment build G5_CHECK_SR.env >> commands.tmp
echo /E:G5_CHECK_SR tools script run G5_CHECK_SR.tst >> commands.tmp
echo /E:G5_CHECK_SR execute batch >> commands.tmp
echo /E:G5_CHECK_SR reports custom management G5_CHECK_SR_management_report.html >> commands.tmp
