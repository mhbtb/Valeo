...
canuint8 MEMORY_ROM LinMsgDefault_LIN_Slave_RLS[2] = {0,0};    /* 0x02"LIN_Slave_RLS" */

canuint8 MEMORY_ROM LinMsgDefault_LinReqCmd[8] = {0,0,0,0,0,0,0,0};    /* 0x3C"LinReqCmd" */
canuint8 MEMORY_ROM LinMsgDefault_LIN_Master_BCM[6] = {0,0,100,0,0,0};    /* 0x01"LIN_Master_BCM" */
...
canuint8 MEMORY_ROM cabLinMsgTimeoutTbl[kLinNumberOfObjects] = {
   ...
   ,(kLinTFrame2 - kLinTHeaderMax)      /* 0x02"LIN_Slave_RLS" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x3C"LinReqCmd" */
   ,(kLinTFrame6 - kLinTHeaderMax)      /* 0x01"LIN_Master_BCM" */
};
