...
canuint8 MEMORY_ROM LinMsgDefault_RlsmCem_Lin1Fr03_CEM_LIN1[8] = {0,14,50,50,0,0,0,0};    /* 0x02"RlsmCem_Lin1Fr03_CEM_LIN1" */
canuint8 MEMORY_ROM LinMsgDefault_RlsmCem_Lin1Fr02_CEM_LIN1[8] = {88,2,0,0,0,0,75,80};    /* 0x2C"RlsmCem_Lin1Fr02_CEM_LIN1" */
...
canuint8 MEMORY_ROM LinMsgDefault_CemCem_Lin1Fr02_CEM_LIN1[7] = {0,0,0,0,0,0,0};    /* 0x07"CemCem_Lin1Fr02_CEM_LIN1" */
...
canuint8 MEMORY_ROM cabLinMsgIDToHandleTbl[0x40] = {
     0xff
    ,0xff
    ,0x04      /* 0x02"RlsmCem_Lin1Fr03_CEM_LIN1" */
    ,0xff
    ,0xff
    ,0x0D      /* 0x05"CemCem_Lin1Fr01_CEM_LIN1" */
    ,0xff
    ,0x0C      /* 0x07"CemCem_Lin1Fr02_CEM_LIN1" */
    ,0xff
    ,0x0A      /* 0x09"CemCem_Lin1Fr04_CEM_LIN1" */
    ,0x09      /* 0x0A"CemCem_Lin1Fr05_CEM_LIN1" */
    ,0xff
    ,0xff
    ,0xff
    ,0xff
    ...
    ,0xff
    ,0xff
    ,0x06      /* 0x15"RlsmCem_Lin1Fr01_CEM_LIN1" */
    ,0xff
    ,0x0B      /* 0x17"CemCem_Lin1Fr03_CEM_LIN1" */
    ,0x02      /* 0x18"RlsmCem_Lin1PartNrFr02_CEM_LIN1" */
    ,0xff
    ,0xff
    ,0xff
    ,0xff
    ...
    ,0xff
    ,0xff
    ,0x03      /* 0x20"RlsmCem_Lin1PartNrFr01_CEM_LIN1" */
    ,0xff
    ,0x01      /* 0x22"RlsmCem_SerNrLin1Fr01_CEM_LIN1" */
    ,0xff
    ,0xff
    ,0xff
    ,0xff
    ,0x08      /* 0x27"CemCem_Lin1Fr06_CEM_LIN1" */
    ,0xff
    ,0xff
    ,0xff
    ,0xff
    ,0x05      /* 0x2C"RlsmCem_Lin1Fr02_CEM_LIN1" */
    ,0xff
    ,0xff
    ,0xff
    ,0xff
...
canuint8 MEMORY_ROM cabLinMsgHandleTbl[kLinNumberOfObjects] = {
    0      /* 0x3D"LinRespCmd" */
   ,1      /* 0x22"RlsmCem_SerNrLin1Fr01_CEM_LIN1" */
   ,2      /* 0x18"RlsmCem_Lin1PartNrFr02_CEM_LIN1" */
   ,3      /* 0x20"RlsmCem_Lin1PartNrFr01_CEM_LIN1" */
   ,4      /* 0x02"RlsmCem_Lin1Fr03_CEM_LIN1" */
   ,5      /* 0x2C"RlsmCem_Lin1Fr02_CEM_LIN1" */
   ,6      /* 0x15"RlsmCem_Lin1Fr01_CEM_LIN1" */
   ,0      /* 0x3C"LinReqCmd" */
   ,1      /* 0x27"CemCem_Lin1Fr06_CEM_LIN1" */
