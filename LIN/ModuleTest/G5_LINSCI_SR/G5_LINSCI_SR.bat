...
echo environment build G5_LINSCI_SR.env >> commands.tmp
echo /E:G5_LINSCI_SR tools script run G5_LINSCI_SR.tst >> commands.tmp
echo /E:G5_LINSCI_SR execute batch >> commands.tmp
echo /E:G5_LINSCI_SR reports custom management G5_LINSCI_SR_management_report.html >> commands.tmp
