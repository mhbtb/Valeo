...
MEMORY_FAR _c_FBCM_ControlCommand_buf FBCM_ControlCommand;
...
canuint8* MEMORY_ROM capbLinRxDataPtrTbl[kLinNumberOfRxObjects] = {
    ...
    ,(canuint8*)FBCM_ControlCommand._c      /* 0x20"FBCM_ControlCommand" */
};
...
canuint8 MEMORY_ROM LinMsgDefault_RS[4] = {0,0,0,0};    /* 0x27"RS" */

canuint8 MEMORY_ROM LinMsgDefault_LinReqCmd[8] = {0,0,0,0,0,0,0,0};    /* 0x3C"LinReqCmd" */
canuint8 MEMORY_ROM LinMsgDefault_FBCM_ControlCommand[8] = {0,255,0,112,0,0,48,0};    /* 0x20"FBCM_ControlCommand" */
...
canuint16 MEMORY_ROM cawLINMessageID[kLinNumberOfObjects] = {
   ...
   ,0x0000      /* 0x27"RS" */
   ,0          /* 0x3C"LinReqCmd" */
   ,0x0020     /* 0x20"FBCM_ControlCommand" */
};
...
canuint8 MEMORY_ROM cabLinMsgTimeoutTbl[kLinNumberOfObjects] = {
   ...
   ,(kLinTFrame4 - kLinTHeaderMax)      /* 0x27"RS" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x3C"LinReqCmd" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x20"FBCM_ControlCommand" */
};
