...
MEMORY_FAR _c_RLS_StatusInfo_buf RLS_StatusInfo;
...
MEMORY_FAR _c_BCM_RLSCtrlCmd_buf BCM_RLSCtrlCmd;
...
canuint8* MEMORY_ROM capbLinTxDataPtrTbl[kLinNumberOfTxObjects] = {
    ...
    ,(canuint8*)RLS_StatusInfo._c      /* 0x33"RLS_StatusInfo" */
};
...
canuint8* MEMORY_ROM capbLinRxDataPtrTbl[kLinNumberOfRxObjects] = {
    ...
    ,(canuint8*)BCM_RLSCtrlCmd._c      /* 0x22"BCM_RLSCtrlCmd" */
};
...
canuint8 MEMORY_ROM LinMsgDefault_RLS_StatusInfo[8] = {0,0,0,0,0,0,0,0};    /* 0x33"RLS_StatusInfo" */

canuint8 MEMORY_ROM LinMsgDefault_LinReqCmd[8] = {0,0,0,0,0,0,0,0};    /* 0x3C"LinReqCmd" */
canuint8 MEMORY_ROM LinMsgDefault_BCM_RLSCtrlCmd[8] = {0,0,0,0,0,0,0,0};    /* 0x22"BCM_RLSCtrlCmd" */
...
canuint16 MEMORY_ROM cawLINMessageID[kLinNumberOfObjects] = {
   ...
   ,0x0000      /* 0x33"RLS_StatusInfo" */
   ,0          /* 0x3C"LinReqCmd" */
   ,0x0000     /* 0x22"BCM_RLSCtrlCmd" */
};
...
canuint8 MEMORY_ROM cabLinMsgHandleTbl[kLinNumberOfObjects] = {
   ...
   ,5      /* 0x33"RLS_StatusInfo" */
   ,0      /* 0x3C"LinReqCmd" */
   ,1      /* 0x22"BCM_RLSCtrlCmd" */
};
...
canuint8 MEMORY_ROM cabLinMsgTimeoutTbl[kLinNumberOfObjects] = {
   ...
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x33"RLS_StatusInfo" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x3C"LinReqCmd" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x22"BCM_RLSCtrlCmd" */
};
