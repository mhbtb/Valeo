...
MEMORY_FAR _c_BCM_LIN1_1_buf BCM_LIN1_1;
...
canuint8* MEMORY_ROM capbLinTxDataPtrTbl[kLinNumberOfTxObjects] = {
    ...
    ,(canuint8*)RLS_2._c      /* 0x18"RLS_2" */
    ,(canuint8*)RLS_1._c      /* 0x29"RLS_1" */
};
...
canuint8* MEMORY_ROM capbLinRxDataPtrTbl[kLinNumberOfRxObjects] = {
    ...
    ,(canuint8*)BCM_LIN1_1._c      /* 0x10"BCM_LIN1_1" */
};
...
canuint8 MEMORY_ROM LinMsgDefault_RLS_2[8] = {255,255,255,255,0,0,0,0};    /* 0x18"RLS_2" */
canuint8 MEMORY_ROM LinMsgDefault_RLS_1[8] = {0,0,0,0,120,0,0,0};    /* 0x29"RLS_1" */

canuint8 MEMORY_ROM LinMsgDefault_LinReqCmd[8] = {0,0,0,0,0,0,0,0};    /* 0x3C"LinReqCmd" */
canuint8 MEMORY_ROM LinMsgDefault_BCM_LIN1_1[8] = {0,96,0,96,20,0,124,0};    /* 0x10"BCM_LIN1_1" */
...
canuint16 MEMORY_ROM cawLINMessageID[kLinNumberOfObjects] = {
    0           /* 0x3D"LinRespCmd" */
   ,0x0006      /* 0x17"ASIC_Frame_04" */
   ,0x0005      /* 0x16"ASIC_Frame_03" */
   ,0x0004      /* 0x15"ASIC_Frame_02" */
   ,0x0003      /* 0x14"ASIC_Frame_01" */
   ,0x0002      /* 0x18"RLS_2" */
   ,0x0001      /* 0x29"RLS_1" */
   ,0          /* 0x3C"LinReqCmd" */
   ,0x0000     /* 0x10"BCM_LIN1_1" */
};
...
canuint8 MEMORY_ROM cabLinMsgTimeoutTbl[kLinNumberOfObjects] = {
   ...
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x18"RLS_2" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x29"RLS_1" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x3C"LinReqCmd" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x10"BCM_LIN1_1" */
};
