...
#define cb_HANDLE_BCM_LIN_1               7
#define cb_HANDLE_BCM_LIN_3               8
...
#define cb_HANDLE_BCM1_LIN1_01_g cb_HANDLE_BCM_LIN_3
#define cb_HANDLE_WWSs_01_g      cb_HANDLE_BCM_LIN_1
...
typedef struct {
  ...
  canbittype                                  STAT_RS: 1;
  canbittype                             STAT_RSError: 1;
  canbittype                               LightOnReq: 1;
  canbittype                        STAT_DayNightMode: 2;
  canbittype                                  STAT_LS: 1;
  canbittype                             STAT_LSError: 1;
  canbittype                            LightOnReason: 2;
  canbittype                             RLS_RspError: 1;
  canbittype                                  unused0: 4;
} _c_RLS_1_msgType;
...
typedef struct {
  canbittype                           STAT_LeverMode: 3;
  canbittype                              EngineState: 3;
  canbittype                        VehicleSpeedValid: 2;
  canbittype                      Cmd_OpenTrunkFOBKey: 2;
  canbittype                           TrunkLidSwitch: 2;
  canbittype                   Cmd_OpenTrunkCockpitSW: 2;
  canbittype                             SATOReminder: 2;
  canbittype                    Set_PLGOpenningHeight: 8;
  canbittype                            STAT_Terminal: 3;
  canbittype                                      Day: 5;
  canbittype                                    Month: 4;
  canbittype                           vehicleSpeed_0: 4;
  canbittype                           vehicleSpeed_1: 8;
  canbittype                                     Year: 7;
  canbittype                                  SATOReq: 1;
  canbittype                      PowerCircuitVoltage: 8;
} _c_BCM_LIN_1_msgType;

typedef struct {
  canbittype                         FrontWiperSwitch: 3;
  canbittype                        FrontWasherSwitch: 2;
  canbittype                       FrontWiperInterval: 3;
  canbittype                        MasterLightSwitch: 3;
  canbittype                       FrontWiperPosition: 1;
  canbittype                                  unused0: 4;
} _c_BCM_LIN_3_msgType;
...
typedef union {
    unsigned char _c[2];
    _c_BCM_LIN_3_msgType bcm_lin_3;
} _c_BCM_LIN_3_buf;
...
extern MEMORY_FAR _c_BCM_LIN_3_buf BCM_LIN_3;
...
#define BCM_LIN_1_ind_b             uLinIndicationFlags.w[0].b1
#define l_flg_tst_BCM_LIN_1()       (BCM_LIN_1_ind_b != 0)
#define l_flg_clr_BCM_LIN_1()       {BCM_LIN_1_ind_b = 0;}
#define BCM_LIN_3_ind_b             uLinIndicationFlags.w[0].b2
#define l_flg_tst_BCM_LIN_3()       (BCM_LIN_3_ind_b != 0)
#define l_flg_clr_BCM_LIN_3()       {BCM_LIN_3_ind_b = 0;}
...
#define WiperSpeed                                                            RLS_1.rls_1.WiperSpeed
#define STAT_RS                                                               RLS_1.rls_1.STAT_RS
#define STAT_RSError                                                          RLS_1.rls_1.STAT_RSError
#define LightOnReq                                                            RLS_1.rls_1.LightOnReq
#define STAT_DayNightMode                                                     RLS_1.rls_1.STAT_DayNightMode
#define STAT_LS                                                               RLS_1.rls_1.STAT_LS
#define STAT_LSError                                                          RLS_1.rls_1.STAT_LSError
#define LightOnReason                                                         RLS_1.rls_1.LightOnReason
#define RLS_RspError                                                          RLS_1.rls_1.RLS_RspError
...
#define STAT_LeverMode                                                        BCM_LIN_1.bcm_lin_1.STAT_LeverMode
#define EngineState                                                           BCM_LIN_1.bcm_lin_1.EngineState
#define VehicleSpeedValid                                                     BCM_LIN_1.bcm_lin_1.VehicleSpeedValid
#define Cmd_OpenTrunkFOBKey                                                   BCM_LIN_1.bcm_lin_1.Cmd_OpenTrunkFOBKey
#define TrunkLidSwitch                                                        BCM_LIN_1.bcm_lin_1.TrunkLidSwitch
#define Cmd_OpenTrunkCockpitSW                                                BCM_LIN_1.bcm_lin_1.Cmd_OpenTrunkCockpitSW
#define SATOReminder                                                          BCM_LIN_1.bcm_lin_1.SATOReminder
#define Set_PLGOpenningHeight                                                 BCM_LIN_1.bcm_lin_1.Set_PLGOpenningHeight
#define STAT_Terminal                                                         BCM_LIN_1.bcm_lin_1.STAT_Terminal
#define Day                                                                   BCM_LIN_1.bcm_lin_1.Day
#define Month                                                                 BCM_LIN_1.bcm_lin_1.Month
#define vehicleSpeed_0                                                        BCM_LIN_1.bcm_lin_1.vehicleSpeed_0
#define vehicleSpeed_1                                                        BCM_LIN_1.bcm_lin_1.vehicleSpeed_1
#define vehicleSpeed(c)                                                       { vehicleSpeed_0= (uint8)(((uint16)(c) & 0x0F));\
                                                                                vehicleSpeed_1= (uint8)(((uint16)(c) & 0xFF) >> 4);\
                                                                              }
#define Year                                                                  BCM_LIN_1.bcm_lin_1.Year
#define SATOReq                                                               BCM_LIN_1.bcm_lin_1.SATOReq
#define PowerCircuitVoltage                                                   BCM_LIN_1.bcm_lin_1.PowerCircuitVoltage
#define FrontWiperSwitch                                                      BCM_LIN_3.bcm_lin_3.FrontWiperSwitch
#define FrontWasherSwitch                                                     BCM_LIN_3.bcm_lin_3.FrontWasherSwitch
#define FrontWiperInterval                                                    BCM_LIN_3.bcm_lin_3.FrontWiperInterval
#define MasterLightSwitch                                                     BCM_LIN_3.bcm_lin_3.MasterLightSwitch
#define FrontWiperPosition                                                    BCM_LIN_3.bcm_lin_3.FrontWiperPosition
...
#define l_bool_rd_STAT_RS()                                                     STAT_RS
#define l_bool_wr_STAT_RS(a)                                                    {STAT_RS = a;}
#define l_bool_rd_STAT_RSError()                                                STAT_RSError
#define l_bool_wr_STAT_RSError(a)                                               {STAT_RSError = a;}
#define l_bool_rd_LightOnReq()                                                  LightOnReq
#define l_bool_wr_LightOnReq(a)                                                 {LightOnReq = a;}
#define l_u8_rd_STAT_DayNightMode()                                         STAT_DayNightMode
#define l_u8_wr_STAT_DayNightMode(a)                                        {STAT_DayNightMode = a;}
#define l_bool_rd_STAT_LS()                                                     STAT_LS
#define l_bool_wr_STAT_LS(a)                                                    {STAT_LS = a;}
#define l_bool_rd_STAT_LSError()                                                STAT_LSError
#define l_bool_wr_STAT_LSError(a)                                               {STAT_LSError = a;}
#define l_u8_rd_LightOnReason()                                             LightOnReason
#define l_u8_wr_LightOnReason(a)                                            {LightOnReason = a;}
#define l_bool_rd_RLS_RspError()                                                RLS_RspError
#define l_bool_wr_RLS_RspError(a)                                               {RLS_RspError = a;}
...
#define l_u8_rd_STAT_LeverMode()                                            STAT_LeverMode
#define l_u8_wr_STAT_LeverMode(a)                                           {STAT_LeverMode = a;}
#define l_u8_rd_EngineState()                                               EngineState
#define l_u8_wr_EngineState(a)                                              {EngineState = a;}
#define l_u8_rd_VehicleSpeedValid()                                         VehicleSpeedValid
#define l_u8_wr_VehicleSpeedValid(a)                                        {VehicleSpeedValid = a;}
#define l_u8_rd_Cmd_OpenTrunkFOBKey()                                       Cmd_OpenTrunkFOBKey
#define l_u8_wr_Cmd_OpenTrunkFOBKey(a)                                      {Cmd_OpenTrunkFOBKey = a;}
#define l_u8_rd_TrunkLidSwitch()                                            TrunkLidSwitch
#define l_u8_wr_TrunkLidSwitch(a)                                           {TrunkLidSwitch = a;}
#define l_u8_rd_Cmd_OpenTrunkCockpitSW()                                    Cmd_OpenTrunkCockpitSW
#define l_u8_wr_Cmd_OpenTrunkCockpitSW(a)                                   {Cmd_OpenTrunkCockpitSW = a;}
#define l_u8_rd_SATOReminder()                                              SATOReminder
#define l_u8_wr_SATOReminder(a)                                             {SATOReminder = a;}
#define l_u8_rd_Set_PLGOpenningHeight()                                     Set_PLGOpenningHeight
#define l_u8_wr_Set_PLGOpenningHeight(a)                                    {Set_PLGOpenningHeight = a;}
#define l_u8_rd_STAT_Terminal()                                             STAT_Terminal
#define l_u8_wr_STAT_Terminal(a)                                            {STAT_Terminal = a;}
#define l_u8_rd_Day()                                                       Day
#define l_u8_wr_Day(a)                                                      {Day = a;}
#define l_u8_rd_Month()                                                     Month
#define l_u8_wr_Month(a)                                                    {Month = a;}
#define l_u16_rd_vehicleSpeed()                                               (canuint16)(vehicleSpeed_0)\
                                                                                | ((canuint16)(vehicleSpeed_1)<<4)
#define l_u16_wr_vehicleSpeed(a)                                              {vehicleSpeed_0 = ((canuint8)a);\
                                                                                 vehicleSpeed_1 = ((canuint8)a>>4);}

#define l_u8_rd_Year()                                                      Year
#define l_u8_wr_Year(a)                                                     {Year = a;}
#define l_bool_rd_SATOReq()                                                     SATOReq
#define l_bool_wr_SATOReq(a)                                                    {SATOReq = a;}
#define l_u8_rd_PowerCircuitVoltage()                                       PowerCircuitVoltage
#define l_u8_wr_PowerCircuitVoltage(a)                                      {PowerCircuitVoltage = a;}
#define l_u8_rd_FrontWiperSwitch()                                          FrontWiperSwitch
#define l_u8_wr_FrontWiperSwitch(a)                                         {FrontWiperSwitch = a;}
#define l_u8_rd_FrontWasherSwitch()                                         FrontWasherSwitch
#define l_u8_wr_FrontWasherSwitch(a)                                        {FrontWasherSwitch = a;}
#define l_u8_rd_FrontWiperInterval()                                        FrontWiperInterval
#define l_u8_wr_FrontWiperInterval(a)                                       {FrontWiperInterval = a;}
#define l_u8_rd_MasterLightSwitch()                                         MasterLightSwitch
#define l_u8_wr_MasterLightSwitch(a)                                        {MasterLightSwitch = a;}
#define l_bool_rd_FrontWiperPosition()                                          FrontWiperPosition
#define l_bool_wr_FrontWiperPosition(a)                                         {FrontWiperPosition = a;}
