...
MEMORY_FAR _c_BCM_LIN_3_buf BCM_LIN_3;
...
canuint8 MEMORY_ROM cabLinTxDataLenTbl[kLinNumberOfTxObjects] = {
     8      /* 0x3D"LinRespCmd" */
    ,8      /* 0x21"ASIC_Frame_04" */
    ,8      /* 0x20"ASIC_Frame_03" */
    ,8      /* 0x1F"ASIC_Frame_02" */
    ,8      /* 0x1E"ASIC_Frame_01" */
    ,2      /* 0x0D"RLS_1" */
};

canuint8* MEMORY_ROM capbLinTxDataPtrTbl[kLinNumberOfTxObjects] = {
     (canuint8*)LinRespCmd._c      /* 0x3D"LinRespCmd" */
    ,(canuint8*)ASIC_Frame_04._c      /* 0x21"ASIC_Frame_04" */
    ,(canuint8*)ASIC_Frame_03._c      /* 0x20"ASIC_Frame_03" */
    ,(canuint8*)ASIC_Frame_02._c      /* 0x1F"ASIC_Frame_02" */
    ,(canuint8*)ASIC_Frame_01._c      /* 0x1E"ASIC_Frame_01" */
    ,(canuint8*)RLS_1._c      /* 0x0D"RLS_1" */
};
...
canuint8* MEMORY_ROM capbLinRxDataPtrTbl[kLinNumberOfRxObjects] = {
    ...
    ,(canuint8*)BCM_LIN_1._c      /* 0x05"BCM_LIN_1" */
    ,(canuint8*)BCM_LIN_3._c      /* 0x15"BCM_LIN_3" */
};
...
canuint8 MEMORY_ROM LinMsgDefault_ASIC_Frame_04[8] = {0,0,0,0,0,0,0,0};    /* 0x21"ASIC_Frame_04" */
canuint8 MEMORY_ROM LinMsgDefault_ASIC_Frame_03[8] = {0,0,0,0,0,0,0,0};    /* 0x20"ASIC_Frame_03" */
canuint8 MEMORY_ROM LinMsgDefault_ASIC_Frame_02[8] = {0,0,0,0,0,0,0,0};    /* 0x1F"ASIC_Frame_02" */
canuint8 MEMORY_ROM LinMsgDefault_ASIC_Frame_01[8] = {0,0,0,0,0,0,0,0};    /* 0x1E"ASIC_Frame_01" */
canuint8 MEMORY_ROM LinMsgDefault_RLS_1[2] = {0,0};    /* 0x0D"RLS_1" */

canuint8 MEMORY_ROM LinMsgDefault_LinReqCmd[8] = {0,0,0,0,0,0,0,0};    /* 0x3C"LinReqCmd" */
canuint8 MEMORY_ROM LinMsgDefault_BCM_LIN_1[8] = {128,0,0,0,0,0,101,255};    /* 0x05"BCM_LIN_1" */
canuint8 MEMORY_ROM LinMsgDefault_BCM_LIN_3[2] = {7,7};    /* 0x15"BCM_LIN_3" */
...
canuint16 MEMORY_ROM cawLINMessageID[kLinNumberOfObjects] = {
    0           /* 0x3D"LinRespCmd" */
   ,0x0000      /* 0x21"ASIC_Frame_04" */
   ,0x0000      /* 0x20"ASIC_Frame_03" */
   ,0x0000      /* 0x1F"ASIC_Frame_02" */
   ,0x0000      /* 0x1E"ASIC_Frame_01" */
   ,0x0000      /* 0x0D"RLS_1" */
   ,0          /* 0x3C"LinReqCmd" */
   ,0x0000     /* 0x05"BCM_LIN_1" */
   ,0x0000     /* 0x15"BCM_LIN_3" */
};
...
canuint8 MEMORY_ROM cabLinMsgIDToHandleTbl[0x40] = {
    ...
    ,0xff
    ,0xff
    ,0x04      /* 0x1E"ASIC_Frame_01" */
    ,0x03      /* 0x1F"ASIC_Frame_02" */
    ,0x02      /* 0x20"ASIC_Frame_03" */
    ,0x01      /* 0x21"ASIC_Frame_04" */
    ,0xff
    ,0xff
    ,0xff
    ,0xff
...
canuint8 MEMORY_ROM cabLinMsgHandleTbl[kLinNumberOfObjects] = {
    0      /* 0x3D"LinRespCmd" */
   ,1      /* 0x21"ASIC_Frame_04" */
   ,2      /* 0x20"ASIC_Frame_03" */
   ,3      /* 0x1F"ASIC_Frame_02" */
   ,4      /* 0x1E"ASIC_Frame_01" */
   ,5      /* 0x0D"RLS_1" */
   ,0      /* 0x3C"LinReqCmd" */
   ,1      /* 0x05"BCM_LIN_1" */
   ,2      /* 0x15"BCM_LIN_3" */
...
canuint8 MEMORY_ROM cabLinMsgTimeoutTbl[kLinNumberOfObjects] = {
   ...
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x21"ASIC_Frame_04" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x20"ASIC_Frame_03" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x1F"ASIC_Frame_02" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x1E"ASIC_Frame_01" */
   ,(kLinTFrame2 - kLinTHeaderMax)      /* 0x0D"RLS_1" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x3C"LinReqCmd" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x05"BCM_LIN_1" */
   ,(kLinTFrame2 - kLinTHeaderMax)      /* 0x15"BCM_LIN_3" */
};
