...
#define cb_HANDLE_AUTOWIPE                5
#define cb_HANDLE_LinReqCmd               6
#define cb_HANDLE_MOTOR                   7
#define cb_HANDLE_WIPESW                  8
...
#define AUTOWIPE_conf_b             uLinConfirmationFlags.w[0].b5
...
#define S_WipeRequst                                                          AUTOWIPE.autowipe.S_WipeRequst
...
#define l_u8_rd_S_WipeRequst()                                              S_WipeRequst
#define l_u8_wr_S_WipeRequst(a)                                             {S_WipeRequst = a;}
...
#define ReadVehicleSpeed()            (byte)(75)
#define IsIgnitionOn()                (byte)(1)
