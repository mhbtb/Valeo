...
MEMORY_FAR _c_LsRLS_light_buf LsRLS_light;
MEMORY_FAR _c_LsRLS_data_buf LsRLS_data;
...
MEMORY_FAR _c_WWECU_data_buf WWECU_data;
MEMORY_FAR _c_LightECU_Config_buf LightECU_Config;
...
canuint8* MEMORY_ROM capbLinTxDataPtrTbl[kLinNumberOfTxObjects] = {
    ...
    ,(canuint8*)FSdata._c      /* 0x25"FSdata" */
    ,(canuint8*)SoSe._c      /* 0x24"SoSe" */
    ,(canuint8*)LsRLS_light._c      /* 0x23"LsRLS_light" */
    ,(canuint8*)LsRLS_data._c      /* 0x22"LsRLS_data" */
};
...
canuint8* MEMORY_ROM capbLinRxDataPtrTbl[kLinNumberOfRxObjects] = {
    ...
    ,(canuint8*)WWECU_data._c      /* 0x31"WWECU_data" */
    ,(canuint8*)LightECU_Config._c      /* 0x30"LightECU_Config" */
};
...
canuint8 MEMORY_ROM LinMsgDefault_FSdata[5] = {255,255,255,255,0};    /* 0x25"FSdata" */
canuint8 MEMORY_ROM LinMsgDefault_SoSe[8] = {0,0,255,255,255,255,255,255};    /* 0x24"SoSe" */
canuint8 MEMORY_ROM LinMsgDefault_LsRLS_light[3] = {0,0,0};    /* 0x23"LsRLS_light" */
canuint8 MEMORY_ROM LinMsgDefault_LsRLS_data[3] = {0,0,0};    /* 0x22"LsRLS_data" */

canuint8 MEMORY_ROM LinMsgDefault_LinReqCmd[8] = {0,0,0,0,0,0,0,0};    /* 0x3C"LinReqCmd" */
canuint8 MEMORY_ROM LinMsgDefault_WWECU_data[2] = {0,0};    /* 0x31"WWECU_data" */
canuint8 MEMORY_ROM LinMsgDefault_LightECU_Config[3] = {0,0,0};    /* 0x30"LightECU_Config" */
...
canuint16 MEMORY_ROM cawLINMessageID[kLinNumberOfObjects] = {
   ...
   ,0x0025      /* 0x25"FSdata" */
   ,0x0024      /* 0x24"SoSe" */
   ,0x0023      /* 0x23"LsRLS_light" */
   ,0x0022      /* 0x22"LsRLS_data" */
   ,0          /* 0x3C"LinReqCmd" */
   ,0x0031     /* 0x31"WWECU_data" */
   ,0x0030     /* 0x30"LightECU_Config" */
};
...
canuint8 MEMORY_ROM cabLinMsgIDToHandleTbl[0x40] = {
    ...
    ,0xff
    ,0xff
    ,0x08      /* 0x22"LsRLS_data" */
    ,0x07      /* 0x23"LsRLS_light" */
    ,0x06      /* 0x24"SoSe" */
    ,0x05      /* 0x25"FSdata" */
    ,0xff
    ,0xff
    ...
    ,0xff
    ,0xff
    ,0x0B      /* 0x30"LightECU_Config" */
    ,0x0A      /* 0x31"WWECU_data" */
    ,0xff
    ,0xff
    ,0xff
    ,0xff
...
canuint8 MEMORY_ROM cabLinMsgTimeoutTbl[kLinNumberOfObjects] = {
   ...
   ,(kLinTFrame5 - kLinTHeaderMax)      /* 0x25"FSdata" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x24"SoSe" */
   ,(kLinTFrame3 - kLinTHeaderMax)      /* 0x23"LsRLS_light" */
   ,(kLinTFrame3 - kLinTHeaderMax)      /* 0x22"LsRLS_data" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x3C"LinReqCmd" */
   ,(kLinTFrame2 - kLinTHeaderMax)      /* 0x31"WWECU_data" */
   ,(kLinTFrame3 - kLinTHeaderMax)      /* 0x30"LightECU_Config" */
};
