...
#define cb_HANDLE_RLS_StatusInfo          5
#define cb_HANDLE_LinReqCmd               6
#define cb_HANDLE_BCM_RLSCtrlCmd          7
...
#define cb_HANDLE_RLSs_01_g       cb_HANDLE_RLS_StatusInfo
#define cb_HANDLE_BCM1_LIN1_01_g  cb_HANDLE_BCM_RLSCtrlCmd
/******************************************************************************/
...
typedef struct {
  ...
  canbittype                          RLS_WdwCloseReq: 1;
  canbittype                     RLS_LightSensorFault: 1;
  canbittype                         RLS_LowBeamOnReq: 1;
  canbittype                   RLS_PositionLightOnReq: 1;
  canbittype                                  unused0: 1;
  canbittype                        RLS_LightSWReason: 3;
  ...
  canbittype                     RLS_wiperSpeed7Level: 3;
  canbittype                      RLS_AmbBrightness_0: 2;
  canbittype                      RLS_AmbBrightness_1: 8;
  canbittype                         RLS_IRBrightness: 8;
} _c_RLS_StatusInfo_msgType;
...
typedef struct {
  ...
  canbittype                       BCM_AutoModeActive: 1;
  canbittype                                  unused0: 1;
...
typedef union {
    unsigned char _c[8];
    _c_RLS_StatusInfo_msgType rls_statusinfo;
} _c_RLS_StatusInfo_buf;
...
typedef union {
    unsigned char _c[8];
    _c_BCM_RLSCtrlCmd_msgType bcm_rlsctrlcmd;
} _c_BCM_RLSCtrlCmd_buf;
...
extern MEMORY_FAR _c_RLS_StatusInfo_buf RLS_StatusInfo;
...
#define RLS_StatusInfo_conf_b             uLinConfirmationFlags.w[0].b5
#define l_flg_tst_RLS_StatusInfo()       (RLS_StatusInfo_conf_b != 0)
#define l_flg_clr_RLS_StatusInfo()       {RLS_StatusInfo_conf_b = 0;}
...
extern MEMORY_FAR _c_BCM_RLSCtrlCmd_buf BCM_RLSCtrlCmd;
...
#define BCM_RLSCtrlCmd_ind_b             uLinIndicationFlags.w[0].b1
#define l_flg_tst_BCM_RLSCtrlCmd()       (BCM_RLSCtrlCmd_ind_b != 0)
#define l_flg_clr_BCM_RLSCtrlCmd()       {BCM_RLSCtrlCmd_ind_b = 0;}
...
#define RLS_WiperSpeed                                                        RLS_StatusInfo.rls_statusinfo.RLS_WiperSpeed
#define RLS_RainSensorFault                                                   RLS_StatusInfo.rls_statusinfo.RLS_RainSensorFault
#define RLS_WdwCloseReq                                                       RLS_StatusInfo.rls_statusinfo.RLS_WdwCloseReq
#define RLS_LightSensorFault                                                  RLS_StatusInfo.rls_statusinfo.RLS_LightSensorFault
#define RLS_LowBeamOnReq                                                      RLS_StatusInfo.rls_statusinfo.RLS_LowBeamOnReq
#define RLS_PositionLightOnReq                                                RLS_StatusInfo.rls_statusinfo.RLS_PositionLightOnReq
#define RLS_LightSWReason                                                     RLS_StatusInfo.rls_statusinfo.RLS_LightSWReason
#define RLS_VoltFault                                                         RLS_StatusInfo.rls_statusinfo.RLS_VoltFault
#define RLS_ResponseError                                                     RLS_StatusInfo.rls_statusinfo.RLS_ResponseError
#define RLS_SolarLeft                                                         RLS_StatusInfo.rls_statusinfo.RLS_SolarLeft
#define RLS_SolarRight                                                        RLS_StatusInfo.rls_statusinfo.RLS_SolarRight
#define RLS_FwBrightness_0                                                    RLS_StatusInfo.rls_statusinfo.RLS_FwBrightness_0
#define RLS_FwBrightness_1                                                    RLS_StatusInfo.rls_statusinfo.RLS_FwBrightness_1
#define RLS_FwBrightness(c)                                                   { RLS_FwBrightness_0= (uint8)((c) & 0xFF);\
                                                                                RLS_FwBrightness_1= (uint8)(((c) & 0x700) >> 8);\
                                                                              }
#define RLS_wiperSpeed7Level                                                  RLS_StatusInfo.rls_statusinfo.RLS_wiperSpeed7Level
#define RLS_AmbBrightness_0                                                   RLS_StatusInfo.rls_statusinfo.RLS_AmbBrightness_0
#define RLS_AmbBrightness_1                                                   RLS_StatusInfo.rls_statusinfo.RLS_AmbBrightness_1
#define RLS_AmbBrightness(c)                                                  { RLS_AmbBrightness_0= (uint8)(((uint16)(c) & 0x03));\
                                                                                RLS_AmbBrightness_1= (uint8)(((uint16)(c) & 0xFF) >> 2);\
                                                                              }
#define RLS_IRBrightness                                                      RLS_StatusInfo.rls_statusinfo.RLS_IRBrightness
...
#define BCM_WiperParkPosition                                                 BCM_RLSCtrlCmd.bcm_rlsctrlcmd.BCM_WiperParkPosition
#define BCM_WiperSwitchStatus                                                 BCM_RLSCtrlCmd.bcm_rlsctrlcmd.BCM_WiperSwitchStatus
#define BCM_FrontWasherStatus                                                 BCM_RLSCtrlCmd.bcm_rlsctrlcmd.BCM_FrontWasherStatus
#define BCM_AutoModeActive                                                    BCM_RLSCtrlCmd.bcm_rlsctrlcmd.BCM_AutoModeActive
#define BCM_PowerMode                                                         BCM_RLSCtrlCmd.bcm_rlsctrlcmd.BCM_PowerMode
#define BCM_RainSensitivity                                                   BCM_RLSCtrlCmd.bcm_rlsctrlcmd.BCM_RainSensitivity
#define BCM_VehicleSpeed_0                                                    BCM_RLSCtrlCmd.bcm_rlsctrlcmd.BCM_VehicleSpeed_0
#define BCM_VehicleSpeed_1                                                    BCM_RLSCtrlCmd.bcm_rlsctrlcmd.BCM_VehicleSpeed_1
#define BCM_VehicleSpeed(c)                                                   { BCM_VehicleSpeed_0= (uint8)(((uint16)(c) & 0xFF));\
                                                                                BCM_VehicleSpeed_1= (uint8)(((uint16)(c) & 0x1F) >> 8);\
                                                                              }
#define BCM_VehicleSpeedValid                                                 BCM_RLSCtrlCmd.bcm_rlsctrlcmd.BCM_VehicleSpeedValid
#define BCM_500nmTransimission                                                BCM_RLSCtrlCmd.bcm_rlsctrlcmd.BCM_500nmTransimission
#define BCM_800nmTransimission                                                BCM_RLSCtrlCmd.bcm_rlsctrlcmd.BCM_800nmTransimission
...
#define l_bool_rd_RLS_WdwCloseReq()                                             RLS_WdwCloseReq
#define l_bool_wr_RLS_WdwCloseReq(a)                                            {RLS_WdwCloseReq = a;}
...
#define l_bool_rd_RLS_PositionLightOnReq()                                      RLS_PositionLightOnReq
#define l_bool_wr_RLS_PositionLightOnReq(a)                                     {RLS_PositionLightOnReq = a;}
#define l_u8_rd_RLS_LightSWReason()                                         RLS_LightSWReason
#define l_u8_wr_RLS_LightSWReason(a)                                        {RLS_LightSWReason = a;}
...
#define l_u16_rd_RLS_FwBrightness()                                         (RLS_FwBrightness_0)\
                                                                                | ((RLS_FwBrightness_1)<<8)
#define l_u16_wr_RLS_FwBrightness(a)                                        {RLS_FwBrightness_0 = ((canuint8)(a & 0xff));\
                                                                             RLS_FwBrightness_1 = ((canuint8)((a & 0x700 )>>8));}
#define l_u8_rd_RLS_wiperSpeed7Level()                                      RLS_wiperSpeed7Level
#define l_u8_wr_RLS_wiperSpeed7Level(a)                                     {RLS_wiperSpeed7Level = a;}
#define l_u16_rd_RLS_AmbBrightness()                                          (canuint16)(RLS_AmbBrightness_0)\
                                                                                | ((canuint16)(RLS_AmbBrightness_1)<<2)
#define l_u16_wr_RLS_AmbBrightness(a)                                         {RLS_AmbBrightness_0 = (a & 0x03);\
                                                                                 RLS_AmbBrightness_1 =((a>>2) & 0xff);}
...
#define l_bool_rd_BCM_AutoModeActive()                                          BCM_AutoModeActive
#define l_bool_wr_BCM_AutoModeActive(a)                                         {BCM_AutoModeActive = a;}
...
#define l_bool_wr_RLS_unused0(a)                                            {RLS_StatusInfo.rls_statusinfo.unused0 = a;}  
#define l_bool_wr_RLS_unused1(a)                                            {RLS_StatusInfo.rls_statusinfo.unused1 =a;}
/*AUTO GEN by tool*/
/**
#define StandbyMode_ON()              (byte)(1 == 1)
#define StandbyMode_OFF()             (byte)(0 == 1)
#define SendStandbyMode_ON()          {}
#define SendStandbyMode_OFF()         {}
**/
#define IsWdwOpen()                   (byte)(l_bool_rd_BCM_AutoModeActive() == 1)
...
#define SendClosedWindowCmd_Close()   {l_bool_wr_RLS_WdwCloseReq(1);}
#define SendClosedWindowCmd_NClose()  {l_bool_wr_RLS_WdwCloseReq(0);}
