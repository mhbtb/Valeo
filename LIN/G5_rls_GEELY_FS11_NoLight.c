...
MEMORY_FAR _c_RS_SENSOR_02_buf RS_SENSOR_02;
...
MEMORY_FAR _c_BCMLin1Fr02_buf BCMLin1Fr02;
MEMORY_FAR _c_WMMLin1Fr01_buf WMMLin1Fr01;
...
canuint8 MEMORY_ROM cabLinTxDataLenTbl[kLinNumberOfTxObjects] = {
     8      /* 0x3D"LinRespCmd" */
    ,8      /* 0x1A"ASIC_Frame_04" */
    ,8      /* 0x19"ASIC_Frame_03" */
    ,8      /* 0x18"ASIC_Frame_02" */
    ,8      /* 0x17"ASIC_Frame_01" */
    ,8      /* 0x16"RS_SENSOR_02" */
    ,8      /* 0x15"RS_SENSOR_01" */
};
...
canuint8* MEMORY_ROM capbLinTxDataPtrTbl[kLinNumberOfTxObjects] = {
    ...
    ,(canuint8*)ASIC_Frame_04._c      /* 0x1A"ASIC_Frame_04" */
    ,(canuint8*)ASIC_Frame_03._c      /* 0x19"ASIC_Frame_03" */
    ,(canuint8*)ASIC_Frame_02._c      /* 0x18"ASIC_Frame_02" */
    ,(canuint8*)ASIC_Frame_01._c      /* 0x17"ASIC_Frame_01" */
    ,(canuint8*)RS_SENSOR_02._c      /* 0x16"RS_SENSOR_02" */
    ,(canuint8*)RS_SENSOR_01._c      /* 0x15"RS_SENSOR_01" */
};
...
canuint8* MEMORY_ROM capbLinRxDataPtrTbl[kLinNumberOfRxObjects] = {
    ...
    ,(canuint8*)BCMLin1Fr02._c      /* 0x05"BCMLin1Fr02" */
    ,(canuint8*)WMMLin1Fr01._c      /* 0x25"WMMLin1Fr01" */
};
...
canuint8 MEMORY_ROM LinMsgDefault_ASIC_Frame_04[8] = {0,0,0,0,0,0,0,0};    /* 0x1A"ASIC_Frame_04" */
...
canuint8 MEMORY_ROM LinMsgDefault_ASIC_Frame_01[8] = {0,0,0,0,0,0,0,0};    /* 0x17"ASIC_Frame_01" */
canuint8 MEMORY_ROM LinMsgDefault_RS_SENSOR_02[8] = {255,255,127,240,0,0,0,0};    /* 0x16"RS_SENSOR_02" */
canuint8 MEMORY_ROM LinMsgDefault_RS_SENSOR_01[8] = {252,0,0,48,79,12,255,255};    /* 0x15"RS_SENSOR_01" */

canuint8 MEMORY_ROM LinMsgDefault_LinReqCmd[8] = {0,0,0,0,0,0,0,0};    /* 0x3C"LinReqCmd" */
canuint8 MEMORY_ROM LinMsgDefault_BCMLin1Fr02[8] = {0,0,0,0,0,120,0,60};    /* 0x05"BCMLin1Fr02" */
canuint8 MEMORY_ROM LinMsgDefault_WMMLin1Fr01[4] = {0,0,0,0};    /* 0x25"WMMLin1Fr01" */
...
canuint16 MEMORY_ROM cawLINMessageID[kLinNumberOfObjects] = {
    0           /* 0x3D"LinRespCmd" */
   ,0x0000      /* 0x1A"ASIC_Frame_04" */
   ,0x0000      /* 0x19"ASIC_Frame_03" */
   ,0x0000      /* 0x18"ASIC_Frame_02" */
   ,0x0000      /* 0x17"ASIC_Frame_01" */
   ,0x0000      /* 0x16"RS_SENSOR_02" */
   ,0x0000      /* 0x15"RS_SENSOR_01" */
   ,0          /* 0x3C"LinReqCmd" */
   ,0x0000     /* 0x05"BCMLin1Fr02" */
   ,0x0000     /* 0x25"WMMLin1Fr01" */
};
...
canuint8 MEMORY_ROM cabLinMsgIDToHandleTbl[0x40] = {
    ...
    ,0xff
    ,0xff
    ,0x06      /* 0x15"RS_SENSOR_01" */
    ,0x05      /* 0x16"RS_SENSOR_02" */
    ,0x04      /* 0x17"ASIC_Frame_01" */
    ,0x03      /* 0x18"ASIC_Frame_02" */
    ,0x02      /* 0x19"ASIC_Frame_03" */
    ,0x01      /* 0x1A"ASIC_Frame_04" */
    ,0xff
    ,0xff
    ,0xff
    ,0xff
...
canuint8 MEMORY_ROM cabLinMsgHandleTbl[kLinNumberOfObjects] = {
    0      /* 0x3D"LinRespCmd" */
   ,1      /* 0x1A"ASIC_Frame_04" */
   ,2      /* 0x19"ASIC_Frame_03" */
   ,3      /* 0x18"ASIC_Frame_02" */
   ,4      /* 0x17"ASIC_Frame_01" */
   ,5      /* 0x16"RS_SENSOR_02" */
   ,6      /* 0x15"RS_SENSOR_01" */
   ,0      /* 0x3C"LinReqCmd" */
   ,1      /* 0x05"BCMLin1Fr02" */
...
canuint8 MEMORY_ROM cabLinMsgTimeoutTbl[kLinNumberOfObjects] = {
   ...
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x1A"ASIC_Frame_04" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x19"ASIC_Frame_03" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x18"ASIC_Frame_02" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x17"ASIC_Frame_01" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x16"RS_SENSOR_02" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x15"RS_SENSOR_01" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x3C"LinReqCmd" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x05"BCMLin1Fr02" */
   ,(kLinTFrame4 - kLinTHeaderMax)      /* 0x25"WMMLin1Fr01" */
};
