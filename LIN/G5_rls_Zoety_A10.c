...
MEMORY_FAR _c_LIN_SLAVE_RLS_buf LIN_SLAVE_RLS;
...
MEMORY_FAR _c_LIN_Master_BCM_buf LIN_Master_BCM;
...
canuint8* MEMORY_ROM capbLinTxDataPtrTbl[kLinNumberOfTxObjects] = {
    ...
    ,(canuint8*)LIN_SLAVE_RLS._c      /* 0x02"LIN_SLAVE_RLS" */
};
...
canuint8* MEMORY_ROM capbLinRxDataPtrTbl[kLinNumberOfRxObjects] = {
    ...
    ,(canuint8*)LIN_Master_BCM._c      /* 0x01"LIN_Master_BCM" */
};
...
canuint8 MEMORY_ROM LinMsgDefault_LIN_SLAVE_RLS[8] = {0,0,0,0,0,0,0,0};    /* 0x02"LIN_SLAVE_RLS" */

canuint8 MEMORY_ROM LinMsgDefault_LinReqCmd[8] = {0,0,0,0,0,0,0,0};    /* 0x3C"LinReqCmd" */
canuint8 MEMORY_ROM LinMsgDefault_LIN_Master_BCM[8] = {0,0,100,0,0,0,0,0};    /* 0x01"LIN_Master_BCM" */
...
canuint16 MEMORY_ROM cawLINMessageID[kLinNumberOfObjects] = {
   ...
   ,0x0000      /* 0x02"LIN_SLAVE_RLS" */
   ,0          /* 0x3C"LinReqCmd" */
   ,0x0000     /* 0x01"LIN_Master_BCM" */
};
...
canuint8 MEMORY_ROM cabLinMsgIDToHandleTbl[0x40] = {
     0xff
    ,0x07      /* 0x01"LIN_Master_BCM" */
    ,0x05      /* 0x02"LIN_SLAVE_RLS" */
    ,0xff
    ,0xff
    ,0xff
    ,0xff
...
canuint8 MEMORY_ROM cabLinMsgHandleTbl[kLinNumberOfObjects] = {
   ...
   ,5      /* 0x02"LIN_SLAVE_RLS" */
   ,0      /* 0x3C"LinReqCmd" */
   ,1      /* 0x01"LIN_Master_BCM" */
};
...
canuint8 MEMORY_ROM cabLinMsgTimeoutTbl[kLinNumberOfObjects] = {
   ...
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x02"LIN_SLAVE_RLS" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x3C"LinReqCmd" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x01"LIN_Master_BCM" */
};
