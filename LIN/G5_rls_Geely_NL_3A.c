...
canuint8 MEMORY_ROM LinMsgDefault_RS_SENSOR_01[8] = {0,0,0,0,0,0,0,0};    /* 0x15"RS_SENSOR_01" */

canuint8 MEMORY_ROM LinMsgDefault_LinReqCmd[8] = {0,0,0,0,0,0,0,0};    /* 0x3C"LinReqCmd" */
canuint8 MEMORY_ROM LinMsgDefault_BCM_02[8] = {0,0,0,0,0,0,0,0};    /* 0x32"BCM_02" */
...
canuint8 MEMORY_ROM cabLinMsgTimeoutTbl[kLinNumberOfObjects] = {
   ...
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x32"BCM_02" */
