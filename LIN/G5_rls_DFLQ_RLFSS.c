...
canuint8* MEMORY_ROM capbLinTxDataPtrTbl[kLinNumberOfTxObjects] = {
    ...
    ,(canuint8*)RLS_02._c      /* 0x11"RLS_02" */
    ,(canuint8*)RLS_01._c      /* 0x23"RLS_01" */
};
...
canuint8 MEMORY_ROM LinMsgDefault_RLS_02[8] = {255,255,255,251,251,3,0,0};    /* 0x11"RLS_02" */
canuint8 MEMORY_ROM LinMsgDefault_RLS_01[8] = {0,0,255,255,3,0,0,0};    /* 0x23"RLS_01" */
...
canuint8 MEMORY_ROM cabLinMsgTimeoutTbl[kLinNumberOfObjects] = {
   ...
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x11"RLS_02" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x23"RLS_01" */
