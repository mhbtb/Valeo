...
MEMORY_FAR _c_BCM_12_buf BCM_12;
MEMORY_FAR _c_BCM_11_buf BCM_11;
...
canuint8* MEMORY_ROM capbLinRxDataPtrTbl[kLinNumberOfRxObjects] = {
    ...
    ,(canuint8*)BCM_12._c      /* 0x2D"BCM_12" */
    ,(canuint8*)BCM_11._c      /* 0x20"BCM_11" */
};
...
canuint8 MEMORY_ROM LinMsgDefault_RLS_1[3] = {0,0,0};    /* 0x23"RLS_1" */

canuint8 MEMORY_ROM LinMsgDefault_LinReqCmd[8] = {0,0,0,0,0,0,0,0};    /* 0x3C"LinReqCmd" */
canuint8 MEMORY_ROM LinMsgDefault_BCM_12[2] = {0,0};    /* 0x2D"BCM_12" */
canuint8 MEMORY_ROM LinMsgDefault_BCM_11[7] = {130,0,0,0,0,0,0};    /* 0x20"BCM_11" */
...
canuint16 MEMORY_ROM cawLINMessageID[kLinNumberOfObjects] = {
    0           /* 0x3D"LinRespCmd" */
   ,0x1025      /* 0x13"ASIC_Frame_04" */
   ,0x1024      /* 0x12"ASIC_Frame_03" */
   ,0x1023      /* 0x11"ASIC_Frame_02" */
   ,0x1022      /* 0x10"ASIC_Frame_01" */
   ,0x0023      /* 0x23"RLS_1" */
   ,0          /* 0x3C"LinReqCmd" */
   ,0x1021     /* 0x2D"BCM_12" */
   ,0x1020     /* 0x20"BCM_11" */
...
canuint8 MEMORY_ROM cabLinMsgTimeoutTbl[kLinNumberOfObjects] = {
   ...
   ,(kLinTFrame3 - kLinTHeaderMax)      /* 0x23"RLS_1" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x3C"LinReqCmd" */
   ,(kLinTFrame2 - kLinTHeaderMax)      /* 0x2D"BCM_12" */
   ,(kLinTFrame7 - kLinTHeaderMax)      /* 0x20"BCM_11" */
};
