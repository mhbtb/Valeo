...
MEMORY_FAR _c_RLS_02_buf RLS_02;
MEMORY_FAR _c_RLS_01_buf RLS_01;
...
MEMORY_FAR _c_BCM_Status_buf BCM_Status;
...
canuint8* MEMORY_ROM capbLinTxDataPtrTbl[kLinNumberOfTxObjects] = {
    ...
    ,(canuint8*)RLS_02._c      /* 0x03"RLS_02" */
    ,(canuint8*)RLS_01._c      /* 0x02"RLS_01" */
};
...
canuint8* MEMORY_ROM capbLinRxDataPtrTbl[kLinNumberOfRxObjects] = {
    ...
    ,(canuint8*)BCM_Status._c      /* 0x01"BCM_Status" */
};
...
canuint8 MEMORY_ROM LinMsgDefault_RLS_02[8] = {254,251,251,251,251,3,0,0};    /* 0x03"RLS_02" */
canuint8 MEMORY_ROM LinMsgDefault_RLS_01[8] = {0,0,254,7,254,7,254,0};    /* 0x02"RLS_01" */

canuint8 MEMORY_ROM LinMsgDefault_LinReqCmd[8] = {0,0,0,0,0,0,0,0};    /* 0x3C"LinReqCmd" */
canuint8 MEMORY_ROM LinMsgDefault_BCM_Status[8] = {0,0,0,0,0,0,0,0};    /* 0x01"BCM_Status" */
...
canuint8 MEMORY_ROM cabLinMsgTimeoutTbl[kLinNumberOfObjects] = {
   ...
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x03"RLS_02" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x02"RLS_01" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x3C"LinReqCmd" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x01"BCM_Status" */
};
