...
MEMORY_FAR _c_BCM_Calibration_buf BCM_Calibration;
...
canuint8* MEMORY_ROM capbLinTxDataPtrTbl[kLinNumberOfTxObjects] = {
    ...
    ,(canuint8*)RLS_LIN_3._c      /* 0x12"RLS_LIN_3" */
    ,(canuint8*)RLS_LIN_2._c      /* 0x0F"RLS_LIN_2" */
    ,(canuint8*)RLS_LIN_1._c      /* 0x0E"RLS_LIN_1" */
};
...
canuint8* MEMORY_ROM capbLinRxDataPtrTbl[kLinNumberOfRxObjects] = {
    ...
    ,(canuint8*)BCM_Calibration._c      /* 0x08"BCM_Calibration" */
    ,(canuint8*)BCM_LIN_2._c      /* 0x07"BCM_LIN_2" */
    ,(canuint8*)BCM_LIN_1._c      /* 0x01"BCM_LIN_1" */
};
...
canuint8 MEMORY_ROM LinMsgDefault_RLS_LIN_3[8] = {0,0,0,0,0,0,0,0};    /* 0x12"RLS_LIN_3" */
canuint8 MEMORY_ROM LinMsgDefault_RLS_LIN_2[8] = {0,0,0,0,0,0,0,0};    /* 0x0F"RLS_LIN_2" */
canuint8 MEMORY_ROM LinMsgDefault_RLS_LIN_1[8] = {0,0,0,0,0,0,0,0};    /* 0x0E"RLS_LIN_1" */

canuint8 MEMORY_ROM LinMsgDefault_LinReqCmd[8] = {0,0,0,0,0,0,0,0};    /* 0x3C"LinReqCmd" */
canuint8 MEMORY_ROM LinMsgDefault_BCM_Calibration[8] = {0,0,0,0,0,0,0,0};    /* 0x08"BCM_Calibration" */
canuint8 MEMORY_ROM LinMsgDefault_BCM_LIN_2[8] = {0,0,0,0,0,0,0,0};    /* 0x07"BCM_LIN_2" */
canuint8 MEMORY_ROM LinMsgDefault_BCM_LIN_1[8] = {0,0,0,0,0,0,0,0};    /* 0x01"BCM_LIN_1" */
...
canuint16 MEMORY_ROM cawLINMessageID[kLinNumberOfObjects] = {
   ...
   ,0x0000      /* 0x12"RLS_LIN_3" */
   ,0x0000      /* 0x0F"RLS_LIN_2" */
   ,0x0000      /* 0x0E"RLS_LIN_1" */
   ,0          /* 0x3C"LinReqCmd" */
   ,0x0000     /* 0x08"BCM_Calibration" */
   ,0x0000     /* 0x07"BCM_LIN_2" */
   ,0x0000     /* 0x01"BCM_LIN_1" */
};
...
canuint8 MEMORY_ROM cabLinMsgTimeoutTbl[kLinNumberOfObjects] = {
   ...
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x12"RLS_LIN_3" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x0F"RLS_LIN_2" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x0E"RLS_LIN_1" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x3C"LinReqCmd" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x08"BCM_Calibration" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x07"BCM_LIN_2" */
   ,(kLinTFrame8 - kLinTHeaderMax)      /* 0x01"BCM_LIN_1" */
};
