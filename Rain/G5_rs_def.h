...
/* 16.08.2017  VCO_249       FCA_Chrysler:Gen3.5A development */
/******************************************************************************/
...
#if defined(GEELY_NL_3A) || defined(DFLQ_RLFSS)
#define RSS_INKREMENTWIPE
#else
//#undef RSS_INKREMENTWIPE
//if need the increase wiper function ,please define RSS_INKREMENTWIPE in G5_projectDefs.h
#endif
...
#if (defined FORD) || (defined GEN3_5A_FCA)
