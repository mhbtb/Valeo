...
static void signal_time_interval(void)
{
  ...
  if(rw_RS_SigVoltage_neg_int_g != 0)
  {
    ...
    for (rb_LookupTable_idx_l = 13; rb_LookupTable_idx_l > 0; rb_LookupTable_idx_l--) //Tianyang WANG 2019-02-22 
#else
...
#endif
    {
      if(cb_RainInt_TransformArray_g[rb_LookupTable_idx_l-1] <= rw_Interval_g)
      {
        ...
        rb_RainInt_IntensityOutput_g = rb_LookupTable_idx_l;
#elif defined CHANG_AN_S311
        rb_RainInt_IntensityOutput_g = rb_LookupTable_idx_l;    //Tianyang WANG 2019-02-22
#else
