...
echo options VCAST_MAX_STRING_LENGTH 100 >> commands.tmp
...
echo environment build G5_ASIC_CONTROL_SR.env >> commands.tmp
echo /E:G5_ASIC_CONTROL_SR tools script run G5_ASIC_CONTROL_SR.tst >> commands.tmp
echo /E:G5_ASIC_CONTROL_SR execute batch >> commands.tmp
echo /E:G5_ASIC_CONTROL_SR reports custom management G5_ASIC_CONTROL_SR_management_report.html >> commands.tmp
