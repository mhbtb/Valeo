...
echo options VCAST_REPOSITORY C:\\workset\\RLS_GP_RLXS_GEN5_DEV\\05_SwDev\\01_SrcCode\\Application\\Peripherals\\ModuleTest\\SPI\\DOORS-requirements >> commands.tmp
...
echo environment build G5_SPI_SR.env >> commands.tmp
echo /E:G5_SPI_SR tools script run G5_SPI_SR.tst >> commands.tmp
echo /E:G5_SPI_SR execute batch >> commands.tmp
echo /E:G5_SPI_SR reports custom management G5_SPI_SR_management_report.html >> commands.tmp
