...
void ASIC_Control_MeasureStandbyMode(void)
{
  ...
  if(time_counter > 60)
  {
    ...
    Enter_Prestandby_Add_Time = 1;
  }
#endif


	First_LIN_Wakeup_Flag = 1;
...
#if 0
#ifndef _NO_RAIN_
#if ( defined(NL_5) || defined(BYTON) || defined(DF_Venucia_532) )
...
static void ASIC_Control_StandbyDecision(void)                          /* evaluate Standby Function*/
{
  ...
  if (rw_STB_LoopIn_ASIC_old_g> 0)                 /* Is loop initialised*/
  {
    if (rw_STB_LoopIn_ASIC_g > rw_STB_LoopIn_ASIC_old_g)  /*Loopin > loopin old*/
    {
      rw_STB_LoopIn_ASIC_difference_g = rw_STB_LoopIn_ASIC_g - rw_STB_LoopIn_ASIC_old_g;   /*calc. difference*/
    }
    else
    {
      rw_STB_LoopIn_ASIC_difference_g = rw_STB_LoopIn_ASIC_old_g-rw_STB_LoopIn_ASIC_g;     /*calc. difference*/
    }
    if (rw_STB_LoopIn_ASIC_difference_g > 120)     /*/difference > Threshold*/
    {
 ...
 /****************************************End**********************************/
  ...
  if ((((((byte)(rw_STB_LoopIn_ASIC_g>>4))) > (byte)(CB_INREC_ABS_UPPER_LEVEL))||((((byte)(rw_STB_LoopIn_ASIC_g>>4))) < (byte)(CB_INREC_ABS_LOWER_LEVEL)))||
      ((rw_STB_LoopIn_ASIC_old_g == 0) &&(((((byte)(rw_STB_LoopIn_ASIC_g>>4))) > (CB_INREC_ABS_UPPER1_LEVEL))||((((byte)(rw_STB_LoopIn_ASIC_g>>4))) < (CB_INREC_ABS_LOWER1_LEVEL))))) // is Loopvoltage out of boarders
  {
    if (((rw_STB_LoopIn_ASIC_g>>4)) > CB_INREC_ABS_UPPER1_LEVEL)    /* higher upper level?*/
    {
...
//      rab_ASIC_CtrReg_DEFAULT[IDX_ACTR_REG] = (rb_ACTR_Reg_g&0xBF);
    ...
    rw_STB_LoopIn_ASIC_old_g = 0;           // reset old loopIn
  }
  else
  {
    
    rw_STB_LoopIn_ASIC_old_g = rw_STB_LoopIn_ASIC_g;       // store old loopin
  }
}
#endif
#endif /*_NO_RAIN*/
...
byte ASIC_Control_STBCheckRain(void)
{
  ...
  return  (rw_LengthSum_s >= 300) ; // LengthSum > Threshold?
