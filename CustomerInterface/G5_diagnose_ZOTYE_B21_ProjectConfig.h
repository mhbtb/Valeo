...
/* {ID  ,   Name}  at least one entry should exist*/           \
  {0x01,"ZOTYE_B21_RS    "}, /* Rain*/                         \
  {0x04,"ZOTYE_B21_LS    "}, /* Light*/                        \
  {0x05,"ZOTYE_B21_RLS   "}, /* Light, Rain*/                  \
  {0x07,"ZOTYE_B21_RLSS  "}, /* Light,Solar, Rain*/            \
  {0x98,"ZOTYE_B21_FS    "}, /* Humidity */                    \
  {0x8A,"ZOTYE_B21_FSS   "}, /* Humidity,Solar */              \
  {0x0C,"ZOTYE_B21_LFS   "}, /* Humidity,Light */              \
  {0x0D,"ZOTYE_B21_RLFS  "}, /* Humidity,Light,Rain */         \
  {0x0E,"ZOTYE_B21_LFSS  "}, /* Humidity,Light,Solar */        \
  {0x0F,"ZOTYE_B21_RLFSS "}  /* Humidity,Light,solar,Rain */   
