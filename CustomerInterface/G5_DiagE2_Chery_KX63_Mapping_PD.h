...
#define cb_NumberofEEPROMCells_PD_g 98  
...
#define CB_DEF_VARIANT_ID          0x00
#define CB_MIN_VARIANT_ID          0x00
#define CB_MAX_VARIANT_ID          0xFF

#define CW_DEF_FUNCTION_ID         0x0000U
...
/*Rain intensity VCO_423: EEPROM coefficient use for the processing of rain intensity*/
#define CB_DEF_INTENSITY_SLOW_ALPHACOEF 0x19
#define CB_MIN_INTENSITY_SLOW_ALPHACOEF 0x00
#define CB_MAX_INTENSITY_SLOW_ALPHACOEF 0xFF

/*Rain intensity VCO_423: EEPROM coefficient use for the processing of rain intensity*/
#define CB_DEF_INTENSITY_SLOW_BETACOEF 0x6b
#define CB_MIN_INTENSITY_SLOW_BETACOEF 0x00
#define CB_MAX_INTENSITY_SLOW_BETACOEF 0xFF

/*Rain intensity VCO_423: EEPROM coefficient use for the processing of rain intensity*/
#define CB_DEF_INTENSITY_FAST_ALPHACOEF 0x14
#define CB_MIN_INTENSITY_FAST_ALPHACOEF 0x00
#define CB_MAX_INTENSITY_FAST_ALPHACOEF 0xFF

/*Rain intensity VCO_423: EEPROM coefficient use for the processing of rain intensity*/
#define CB_DEF_INTENSITY_FAST_BETACOEF 0x3e
#define CB_MIN_INTENSITY_FAST_BETACOEF 0x00
#define CB_MAX_INTENSITY_FAST_BETACOEF 0xFF

/* Rain intensity VCO_423: Threshold for Signal voltage */
...
const byte __far cb_EEPROMDataDefaultMinMax_PD_g[cb_NumberofEEPROMCells_PD_g][3] = {
  ...
  {CB_DEF_IDRLSs_02                      ,CB_MIN_IDRLSs_02                      ,CB_MAX_IDRLSs_02                     },      /*325*/
  {CB_DEF_IDRLSS_01                      ,CB_MIN_IDRLSS_01                      ,CB_MAX_IDRLSS_01                      },      /*326*/
  {CB_DEF_BCM1_LIN1_01                   ,CB_MIN_BCM1_LIN1_01                   ,CB_MAX_BCM1_LIN1_01                   },      /*327*/
  {CB_DEF_BCM1_LIN1_02                   ,CB_MIN_BCM1_LIN1_02                   ,CB_MAX_BCM1_LIN1_02                        },      /*328*/
  {CB_DEF_BCM1_LIN1_03                   ,CB_MIN_BCM1_LIN1_03                   ,CB_MAX_BCM1_LIN1_03                       },      /*329*/
#ifdef ASIC_TEST 
  ...
  {CB_DEF_INTENSITY_SLOW_ALPHACOEF       ,CB_MIN_INTENSITY_SLOW_ALPHACOEF       ,CB_MAX_INTENSITY_SLOW_ALPHACOEF       },       /*348*/
  {CB_DEF_INTENSITY_SLOW_BETACOEF        ,CB_MIN_INTENSITY_SLOW_BETACOEF        ,CB_MAX_INTENSITY_SLOW_BETACOEF        },       /*349*/
  {CB_DEF_INTENSITY_FAST_ALPHACOEF       ,CB_MIN_INTENSITY_FAST_ALPHACOEF       ,CB_MAX_INTENSITY_FAST_ALPHACOEF       },       /*350*/
  {CB_DEF_INTENSITY_FAST_BETACOEF        ,CB_MIN_INTENSITY_FAST_BETACOEF        ,CB_MAX_INTENSITY_FAST_BETACOEF        },       /*351*/
  {CB_DEF_THR_SIGVOLTAGEH                ,CB_MIN_THR_SIGVOLTAGEH                ,CB_MAX_THR_SIGVOLTAGEH                },       /*352*/
  {CB_DEF_THR_SIGVOLTAGEL                ,CB_MIN_THR_SIGVOLTAGEL                ,CB_MAX_THR_SIGVOLTAGEL                },       /*353*/ 
...
typedef struct {
  ...
  byte IDBCM1_LIN1_02;                /*328*/
  byte IDBCM1_LIN1_03 ;               /*329*/ 
#ifdef ASIC_TEST
  ...
  byte Intensity_Slow_AlphaCoef;      /*348*/
  byte Intensity_Slow_BetaCoef;       /*349*/
  byte Intensity_Fast_AlphaCoef;      /*350*/
  byte Intensity_Fast_BetaCoef;       /*351*/
  byte THR_SIGVOLTAGEH;               /*352*/
  byte THR_SIGVOLTAGEL;               /*353*/
...
#define Intensity_Slow_AlphaCoef_g                      EEPROM_Struct_PD.EEPROMStructPD.Intensity_Slow_AlphaCoef
#define Intensity_Slow_BetaCoef_g                       EEPROM_Struct_PD.EEPROMStructPD.Intensity_Slow_BetaCoef
#define Intensity_Fast_AlphaCoef_g                      EEPROM_Struct_PD.EEPROMStructPD.Intensity_Fast_AlphaCoef
#define Intensity_Fast_BetaCoef_g                       EEPROM_Struct_PD.EEPROMStructPD.Intensity_Fast_BetaCoef

#define rb_THR_SIGVOLTAGEH                              EEPROM_Struct_PD.EEPROMStructPD.THR_SIGVOLTAGEH                     
#define rb_THR_SIGVOLTAGEL                              EEPROM_Struct_PD.EEPROMStructPD.THR_SIGVOLTAGEL                        
...
#define CW_E2_IDBCM1_LIN1_03_ADRESS       (329)
...
#define CW_E2_IDRLSS_02_ADRESS        (348)
