...
#define SYSTEM_NAMES_RLS                                       \
  {0x01,"CheryKX63RS     "}, /* Rain*/                         \
  {0x04,"CheryKX63LS     "}, /* Light*/                        \
  {0x05,"CheryKX63RLS    "}, /* Light, Rain*/                  \
  {0x07,"CheryKX63RLSS   "}, /* Light,Solar, Rain*/            \
  {0x98,"CheryKX63F      "}, /* Humidity */                    \
  {0x8A,"CheryKX63FSS    "}, /* Humidity,Solar */              \
  {0x0C,"CheryKX63LFS    "}, /* Humidity,Light */              \
  {0x0D,"CheryKX63RLFS   "}, /* Humidity,Light,Rain */         \
  {0x0E,"CheryKX63LFSS   "}, /* Humidity,Light,Solar */        \
  {0x0F,"CheryKX63RLFSS  "}  /* Humidity,Light,solar,Rain */    
