...
#define cb_INITAL_TARGET_ADDRESS_s    0x21
...
#define SYSTEM_NAMES_RLS                                       \
  {0x01,"CHJ_M01_RS      "}, /* Rain*/                         \
  {0x04,"CHJ_M01_LS      "}, /* Light*/                        \
  {0x05,"CHJ_M01_RLS     "}, /* Light, Rain*/                  \
  {0x07,"CHJ_M01_RLSS    "}, /* Light,Solar, Rain*/            \
  {0x98,"CHJ_M01_FeuchteS"}, /* Humidity */                    \
  {0x8A,"CHJ_M01_FSS     "}, /* Humidity,Solar */              \
  {0x0C,"CHJ_M01_LFS     "}, /* Humidity,Light */              \
  {0x0D,"CHJ_M01_RLFS    "}, /* Humidity,Light,Rain */         \
  {0x0E,"CHJ_M01_LFSS    "}, /* Humidity,Light,Solar */        \
  {0x0F,"CHJ_M01_RLFSS   "}  /* Humidity,Light,solar,Rain */    
