...
/* {ID  ,   Name}  at least one entry should exist*/           \
  {0x01,"ZOTYE_BO1_RS    "}, /* Rain*/                         \
  {0x04,"ZOTYE_BO1_LS    "}, /* Light*/                        \
  {0x05,"ZOTYE_BO1_RLS   "}, /* Light, Rain*/                  \
  {0x07,"ZOTYE_BO1_RLSS  "}, /* Light,Solar, Rain*/            \
  {0x98,"ZOTYE_BO1_FS    "}, /* Humidity */                    \
  {0x8A,"ZOTYE_BO1_FSS   "}, /* Humidity,Solar */              \
  {0x0C,"ZOTYE_BO1_LFS   "}, /* Humidity,Light */              \
  {0x0D,"ZOTYE_BO1_RLFS  "}, /* Humidity,Light,Rain */         \
  {0x0E,"ZOTYE_BO1_LFSS  "}, /* Humidity,Light,Solar */        \
  {0x0F,"ZOTYE_BO1_RLFSS "}  /* Humidity,Light,solar,Rain */   
