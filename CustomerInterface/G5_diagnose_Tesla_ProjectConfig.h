...
#define cb_INITAL_TARGET_ADDRESS_s    0x7D
...
/* {ID  ,   Name}  at least one entry should exist*/           \
  {0x01,"TESLA_RS        "}, /* Rain*/                         \
  {0x04,"TESLA_LS        "}, /* Light*/                        \
  {0x05,"TESLA_RLS       "}, /* Light, Rain*/                  \
  {0x07,"TESLA_RLSS      "}, /* Light,Solar, Rain*/            \
  {0x08,"TESLA_FeuchteS  "}, /* Humidity */                    \
  {0x0C,"TESLA_LFS       "}, /* Humidity,Light */              \
  {0x0D,"TESLA_RLFS      "}, /* Humidity,Light,Rain */         \
  {0x0E,"TESLA_LFSS      "}, /* Humidity,Light,Solar */        \
  {0x0F,"TESLA_RLFSS     "}  /* Humidity,Light,solar,Rain */   
