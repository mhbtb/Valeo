...
/* {ID  ,   Name}  at least one entry should exist*/           \
  {0x01,"DFLQ_RS         "}, /* Rain*/                         \
  {0x04,"DFLQ_LS         "}, /* Light*/                        \
  {0x05,"DFLQ_RLS        "}, /* Light, Rain*/                  \
  {0x07,"DFLQ_RLSS       "}, /* Light,Solar, Rain*/            \
  {0x98,"DFLQ_FeuchteS   "}, /* Humidity */                    \
  {0x8A,"DFLQ_FSS        "}, /* Humidity,Solar */              \
  {0x0C,"DFLQ_LFS        "}, /* Humidity,Light */              \
  {0x0D,"DFLQ_RLFS       "}, /* Humidity,Light,Rain */         \
  {0x0E,"DFLQ_LFSS       "}, /* Humidity,Light,Solar */        \
  {0x0F,"DFLQ_RLFSS      "}  /* Humidity,Light,solar,Rain */   
