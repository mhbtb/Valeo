...
#define cb_NumberofEEPROMCells_PD_g (93+2+3)  
...
#define CW_MAX_A_FACTOR_ALS5 (word)0xBFFFU
...
#define CB_DEF_BCM1_LIN1_01                 0x32
...
const byte __far cb_EEPROMDataDefaultMinMax_PD_g[cb_NumberofEEPROMCells_PD_g][3] = {
  ...
  {CB_DEF_HUD_FACTOR                     ,CB_MIN_HUD_FACTOR                     ,CB_MAX_HUD_FACTOR                  },         /*349*/  
  {30,1,200},
  {0,0,255},
  {0,0,255},
  {0,0,255},
...
typedef struct {
  ...
  byte IDSPARE_01 ;                  /*347*/ 
  byte IDRLSs_02;                    /*348*/
  byte HUD_Factor_g;                 /*349*/
  byte preStandbyRainTH_g;           /*350*/
  byte LINDATADUMP_READ_B0;          /*351*/
  byte LINDATADUMP_READ_B1;          /*351*/
  byte LINDATADUMP_READ_B2;          /*351*/
...
#define rb_preStandbyRainTH_g                           EEPROM_Struct_PD.EEPROMStructPD.preStandbyRainTH_g
#define LINDATADUMP_READ_B0                             EEPROM_Struct_PD.EEPROMStructPD.LINDATADUMP_READ_B0           /*351*/
#define LINDATADUMP_READ_B1                             EEPROM_Struct_PD.EEPROMStructPD.LINDATADUMP_READ_B1           /*352*/
#define LINDATADUMP_READ_B2                             EEPROM_Struct_PD.EEPROMStructPD.LINDATADUMP_READ_B2           /*353*/
