...
#define SYSTEM_NAMES_RLS                                       \
  {0x01,"Zoety_A10_RS    "}, /* Rain*/                         \
  {0x04,"Zoety_A10_LS    "}, /* Light*/                        \
  {0x05,"Zoety_A10_RLS   "}, /* Light, Rain*/                  \
  {0x07,"Zoety_A10_RLSS  "}, /* Light,Solar, Rain*/            \
  {0x98,"Zoety_A10_FS    "}, /* Humidity */                    \
  {0x8A,"Zoety_A10_FSS   "}, /* Humidity,Solar */              \
  {0x0C,"Zoety_A10_LFS   "}, /* Humidity,Light */              \
  {0x0D,"Zoety_A10_RLFS  "}, /* Humidity,Light,Rain */         \
  {0x0E,"Zoety_A10_LFSS  "}, /* Humidity,Light,Solar */        \
  {0x0F,"Zoety_A10_RLFSS "}  /* Humidity,Light,solar,Rain */    
