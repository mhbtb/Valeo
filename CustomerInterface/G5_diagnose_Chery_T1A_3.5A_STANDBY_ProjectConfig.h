...
#define SYSTEM_NAMES_RLS                                       \
  {0x01,"Chery_T1A_RS    "}, /* Rain*/                         \
  {0x04,"Chery_T1A_LS    "}, /* Light*/                        \
  {0x05,"Chery_T1A_RLS   "}, /* Light, Rain*/                  \
  {0x07,"Chery_T1A_RLSS  "}, /* Light,Solar, Rain*/            \
  {0x98,"Chery_T1A_F     "}, /* Humidity */                    \
  {0x8A,"Chery_T1A_FSS   "}, /* Humidity,Solar */              \
  {0x0C,"Chery_T1A_LFS   "}, /* Humidity,Light */              \
  {0x0D,"Chery_T1A_RLFS  "}, /* Humidity,Light,Rain */         \
  {0x0E,"Chery_T1A_LFSS  "}, /* Humidity,Light,Solar */        \
  {0x0F,"Chery_T1A_RLS   "}  /* Humidity,Light,solar,Rain */    
