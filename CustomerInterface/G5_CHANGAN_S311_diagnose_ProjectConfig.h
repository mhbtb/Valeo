...
/* {ID  ,   Name}  at least one entry should exist*/           \
  {0x01,"ChangAn_RS      "}, /* Rain*/                         \
  {0x04,"ChangAn_LS      "}, /* Light*/                        \
  {0x05,"ChangAn_RLS     "}, /* Light, Rain*/                  \
  {0x07,"ChangAn_RLSS    "}, /* Light,Solar, Rain*/            \
  {0x98,"ChangAn_FeuchteS"}, /* Humidity */                    \
  {0x8A,"ChangAn_FSS     "}, /* Humidity,Solar */              \
  {0x0C,"ChangAn_LFS     "}, /* Humidity,Light */              \
  {0x0D,"ChangAn_RLFS    "}, /* Humidity,Light,Rain */         \
  {0x0E,"ChangAn_LFSS    "}, /* Humidity,Light,Solar */        \
  {0x0F,"ChangAn_RLFSS   "}  /* Humidity,Light,solar,Rain */   
