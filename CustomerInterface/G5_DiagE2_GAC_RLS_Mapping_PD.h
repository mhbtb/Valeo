...
#define cb_NumberofEEPROMCells_PD_g (93+3)  
...
typedef struct {
  ...
  byte IDSPARE_01 ;                /*347*/ 
  byte IDRLSs_02;                  /*348*/
  byte GAC_SW_Version;             /*349*/
  byte GAC_HW_Version;             /*350*/
  byte GAC_Vehicle_Type;           /*351*/
...
#define rb_GAC_SW_Version                                 EEPROM_Struct_PD.EEPROMStructPD.GAC_SW_Version  
#define rb_GAC_HW_Version                                 EEPROM_Struct_PD.EEPROMStructPD.GAC_HW_Version 
#define rb_GAC_Vehicle_Type                               EEPROM_Struct_PD.EEPROMStructPD.GAC_Vehicle_Type
...
#define cw_E2_VEHICLE_CODING_ADDRESS_g    (351)
