...
#define SYSTEM_NAMES_RLS                                       \
  {0x01,"FS11_RS    "}, /* Rain*/                         \
  {0x04,"FS11_LS    "}, /* Light*/                        \
  {0x05,"FS11_RHS   "}, /* Light, HUD*/                  \
  {0x07,"FS11_RLSS  "}, /* Light,Solar, Rain*/            \
  {0x98,"FS11_F     "}, /* Humidity */                    \
  {0x8A,"FS11_FSS   "}, /* Humidity,Solar */              \
  {0x0C,"FS11_LFS   "}, /* Humidity,Light */              \
  {0x0D,"GFS11_RLFS  "}, /* Humidity,Light,Rain */         \
  {0x0E,"FS11_LFSS  "}, /* Humidity,Light,Solar */        \
  {0x0F,"FS11_RLFSS "}  /* Humidity,Light,solar,Rain */    
