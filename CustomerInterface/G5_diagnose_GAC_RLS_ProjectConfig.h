...
/* {ID  ,   Name}  at least one entry should exist*/           \
  {0x01,"GAC_RS         "}, /* Rain*/                         \
  {0x04,"GAC_LS         "}, /* Light*/                        \
  {0x05,"GAC_RLS        "}, /* Light, Rain*/                  \
  {0x07,"GAC_RLSS       "}, /* Light,Solar, Rain*/            \
  {0x98,"GAC_FeuchteS   "}, /* Humidity */                    \
  {0x8A,"GAC_FSS        "}, /* Humidity,Solar */              \
  {0x0C,"GAC_LFS        "}, /* Humidity,Light */              \
  {0x0D,"GAC_RLFS       "}, /* Humidity,Light,Rain */         \
  {0x0E,"GAC_LFSS       "}, /* Humidity,Light,Solar */        \
  {0x0F,"GAC_RLFSS      "}  /* Humidity,Light,solar,Rain */   
