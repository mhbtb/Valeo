...
#define SYSTEM_NAMES_RLS                                       \
  {0x01,"BYTON_RS        "}, /* Rain*/                         \
  {0x04,"BYTON_LS        "}, /* Light*/                        \
  {0x05,"BYTON_RLS       "}, /* Light, Rain*/                  \
  {0x07,"BYTON_RLSS      "}, /* Light,Solar, Rain*/            \
  {0x98,"BYTON_FeuchteS  "}, /* Humidity */                    \
  {0x8A,"BYTON_FSS       "}, /* Humidity,Solar */              \
  {0x0C,"BYTON_LFS       "}, /* Humidity,Light */              \
  {0x0D,"BYTON_RLFS      "}, /* Humidity,Light,Rain */         \
  {0x0E,"BYTON_LFSS      "}, /* Humidity,Light,Solar */        \
  {0x0F,"BYTON_RLFSS     "}  /* Humidity,Light,solar,Rain */    
