    ...
    case 0: /* Defined externs */
      switch( VCAST_PARAM_INDEX ) {
            ...
            case 56:
              ...
              break;
            case 57:
              /* For rb_ASIC_ALSx_ShortDetected_cnt_g */
      ...
      break;
        case 1:
          /* For sci_init */
          VCAST_RUN_DATA_IF_9( 35, VCAST_PARAM_INDEX );
          break;
        case 2:
          /* For Check_StartupActiveErrors */
          VCAST_RUN_DATA_IF_9( 36, VCAST_PARAM_INDEX );
          break;
        case 3:
          /* For get_rb_LightVetoCounter_g */
          VCAST_RUN_DATA_IF_9( 37, VCAST_PARAM_INDEX );
          break;
        case 4:
          /* For get_rw_Amb_light16bit_g */
          VCAST_RUN_DATA_IF_9( 38, VCAST_PARAM_INDEX );
          break;
        case 5:
          /* For get_rl_HUD_light32bit_g */
          VCAST_RUN_DATA_IF_9( 39, VCAST_PARAM_INDEX );
          break;
        case 6:
          /* For get_rw_IR_light16bit_g */
          VCAST_RUN_DATA_IF_9( 40, VCAST_PARAM_INDEX );
          break;
        case 7:
          /* For get_rb_LightSignalErrorCnt_g */
          VCAST_RUN_DATA_IF_9( 41, VCAST_PARAM_INDEX );
          break;
        case 8:
          /* For get_rb_VDD_LightSignalErrorCnt_g */
          VCAST_RUN_DATA_IF_9( 42, VCAST_PARAM_INDEX );
          break;
        case 9:
