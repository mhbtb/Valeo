...
#define cb_INITAL_TARGET_ADDRESS_s    0x03
...
#define cb_SWSTAND_ADD_ON_WITH_RAIN_g   'D'      /* increase for subversion can be read out at address 80 */
...
#define SYSTEM_NAMES_RLS                                       \
  {0x01,"GEELY2.0_RS    "}, /* Rain*/                         \
  {0x04,"GEELY2.0_LS    "}, /* Light*/                        \
  {0x05,"GEELY2.0_RLS   "}, /* Rain,Light HUD*/                  \
  {0x06,"GEELY2.0_LSS    "}, /* Light, Solar*/                        \
  {0x07,"GEELY2.0_RLSS  "}, /* Light,Solar, Rain*/            \
  {0x98,"GEELY2.0_F     "}, /* Humidity */                    \
  {0x8A,"GEELY2.0_FSS   "}, /* Humidity,Solar */              \
  {0x0C,"GEELY2.0_LFS   "}, /* Humidity,Light */              \
  {0x0D,"GEELY2.0_RLFS  "}, /* Humidity,Light,Rain */         \
  {0x0E,"GEELY2.0_LFSS  "}, /* Humidity,Light,Solar */        \
  {0x0F,"GEELY2.0_RLFSS  "}  /* Humidity,Light,solar,Rain */    
