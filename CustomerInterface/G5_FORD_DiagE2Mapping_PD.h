...
/* 20.01.17   VDR_1025    NB  FORD_3.5A:Internal transmission vales 5% less than carcode configured in the EEPROM  */
...
#define CB_DEF_IDRLSS_01                    0x85
#define CB_MIN_IDRLSS_01                    0
#define CB_MAX_IDRLSS_01                    0xff

#define CB_DEF_IDFSS_ENH_01                 0x42
...
#define CB_DEF_ERR_DATA_01                    0xB1
#define CB_MIN_ERR_DATA_01                    0x00
#define CB_MAX_ERR_DATA_01                    0xFF

#define CB_DEF_LINID_SPARE_01                  0xF5
...
#define CB_DEF_ERASE_COUNTER 0xFF
...
/* Byte 2*/
#define rb_550nm_Transmission_g         (((EEPROM_Struct_PD.EEPROMStructPD.EEKodierbyte2_g & 0x0F)*5)+20)
#define rb_880nm_Transmission_g         ((((EEPROM_Struct_PD.EEPROMStructPD.EEKodierbyte2_g & 0xF0)>>4)*5)+20)
