...
/* 10.11.15     VCO_924    SP    Licht an bei Regen is set to aktiv as default   */
#include "G5_projectDefs.h"

#define cb_NumberofEEPROMCells_PD_g 122  
...
#define CB_DEF_880NM_TRANSMISSION           45
#define CB_MIN_880NM_TRANSMISSION           0      
#define CB_MAX_880NM_TRANSMISSION           100

#define CB_DEF_550NM_TRANSMISSION           75
#define CB_MIN_550NM_TRANSMISSION           0     
#define CB_MAX_550NM_TRANSMISSION           100
...
#else
#define CB_DEF_KODIERBYTE_0 0x42
#endif /*_NO_RAIN_*/
...
/*is RS enabled?*/
#ifndef _NO_RAIN_
#define CB_DEF_RSCONTROLFLAGS               0x0F
#else
...
#define CB_DEF_BCM1_LIN1_01                 0xc4 /*Hammin_code*/
#define CB_MIN_BCM1_LIN1_01                 0
#define CB_MAX_BCM1_LIN1_01                 0xff

#define CB_DEF_WWSS_01                      0x8b /*Hammin_code*/
#define CB_MIN_WWSS_01                      0
#define CB_MAX_WWSS_01                      0xff

#define CB_DEF_SOSES_01                    0x40
...
#define CB_DEF_LINID_TRANSMISSION_01           0xd6 /*Hammin_code*/
#define CB_MIN_LINID_TRANSMISSION_01           0x00
#define CB_MAX_LINID_TRANSMISSION_01           0xFF
...
#define CB_DEF_SYSTEM_SUPPLIER_ID_NUMBER_1 '3'
#define CB_MIN_SYSTEM_SUPPLIER_ID_NUMBER_1 0x00
#define CB_MAX_SYSTEM_SUPPLIER_ID_NUMBER_1 0xFF


#define CB_DEF_SYSTEM_SUPPLIER_ID_NUMBER_2 'G'
#define CB_MIN_SYSTEM_SUPPLIER_ID_NUMBER_2 0x00
#define CB_MAX_SYSTEM_SUPPLIER_ID_NUMBER_2 0xFF


#define CB_DEF_SYSTEM_SUPPLIER_ID_NUMBER_3 '2'
#define CB_MIN_SYSTEM_SUPPLIER_ID_NUMBER_3 0x00
#define CB_MAX_SYSTEM_SUPPLIER_ID_NUMBER_3 0xFF

#define CB_DEF_SYSTEM_SUPPLIER_ID_NUMBER_4 '1'
#define CB_MIN_SYSTEM_SUPPLIER_ID_NUMBER_4 0x00
#define CB_MAX_SYSTEM_SUPPLIER_ID_NUMBER_4 0xFF

#define CB_DEF_SYSTEM_SUPPLIER_ID_NUMBER_5 ' '
#define CB_MIN_SYSTEM_SUPPLIER_ID_NUMBER_5 0x00
#define CB_MAX_SYSTEM_SUPPLIER_ID_NUMBER_5 0xFF


#define CB_DEF_ECU_NAME_DATA_NUMBER_1  ' '
#define CB_MIN_ECU_NAME_DATA_NUMBER_1  0x00
#define CB_MAX_ECU_NAME_DATA_NUMBER_1  0xFF

#define CB_DEF_ECU_NAME_DATA_NUMBER_2  ' '
#define CB_MIN_ECU_NAME_DATA_NUMBER_2  0x00
#define CB_MAX_ECU_NAME_DATA_NUMBER_2  0xFF

#define CB_DEF_ECU_NAME_DATA_NUMBER_3  ' '
#define CB_MIN_ECU_NAME_DATA_NUMBER_3  0x00
#define CB_MAX_ECU_NAME_DATA_NUMBER_3  0xFF

#define CB_DEF_ECU_NAME_DATA_NUMBER_4  ' '
#define CB_MIN_ECU_NAME_DATA_NUMBER_4  0x00
#define CB_MAX_ECU_NAME_DATA_NUMBER_4  0xFF

#define CB_DEF_ECU_NAME_DATA_NUMBER_5  ' '
#define CB_MIN_ECU_NAME_DATA_NUMBER_5  0x00
#define CB_MAX_ECU_NAME_DATA_NUMBER_5  0xFF

#define CB_DEF_ECU_NAME_DATA_NUMBER_6  ' '
#define CB_MIN_ECU_NAME_DATA_NUMBER_6  0x00
#define CB_MAX_ECU_NAME_DATA_NUMBER_6  0xFF

#define CB_DEF_ECU_NAME_DATA_NUMBER_7  ' '
#define CB_MIN_ECU_NAME_DATA_NUMBER_7  0x00
#define CB_MAX_ECU_NAME_DATA_NUMBER_7  0xFF

#define CB_DEF_ECU_NAME_DATA_NUMBER_8  ' '
#define CB_MIN_ECU_NAME_DATA_NUMBER_8  0x00
#define CB_MAX_ECU_NAME_DATA_NUMBER_8  0xFF

#define CB_DEF_ECU_NAME_DATA_NUMBER_9  ' '
#define CB_MIN_ECU_NAME_DATA_NUMBER_9  0x00
#define CB_MAX_ECU_NAME_DATA_NUMBER_9  0xFF

#define CB_DEF_ECU_NAME_DATA_NUMBER_10  ' '
#define CB_MIN_ECU_NAME_DATA_NUMBER_10  0x00
#define CB_MAX_ECU_NAME_DATA_NUMBER_10  0xFF

#define CB_DEF_ECU_NAME_DATA_NUMBER_11  ' '
#define CB_MIN_ECU_NAME_DATA_NUMBER_11  0x00
#define CB_MAX_ECU_NAME_DATA_NUMBER_11  0xFF

#define CB_DEF_ECU_NAME_DATA_NUMBER_12  ' '
#define CB_MIN_ECU_NAME_DATA_NUMBER_12  0x00
#define CB_MAX_ECU_NAME_DATA_NUMBER_12  0xFF

#define CB_DEF_ECU_NAME_DATA_NUMBER_13  ' '
#define CB_MIN_ECU_NAME_DATA_NUMBER_13  0x00
#define CB_MAX_ECU_NAME_DATA_NUMBER_13  0xFF

#define CB_DEF_ECU_NAME_DATA_NUMBER_14  ' '
#define CB_MIN_ECU_NAME_DATA_NUMBER_14  0x00
#define CB_MAX_ECU_NAME_DATA_NUMBER_14  0xFF

#define CB_DEF_ECU_NAME_DATA_NUMBER_15  ' '
#define CB_MIN_ECU_NAME_DATA_NUMBER_15  0x00
#define CB_MAX_ECU_NAME_DATA_NUMBER_15  0xFF

#define CB_DEF_ECU_PART_NUMBER_1 0x60
#define CB_MIN_ECU_PART_NUMBER_1 0x00
#define CB_MAX_ECU_PART_NUMBER_1 0xFF
 
#define CB_DEF_ECU_PART_NUMBER_2 0x78
#define CB_MIN_ECU_PART_NUMBER_2 0x00
#define CB_MAX_ECU_PART_NUMBER_2 0xFF

#define CB_DEF_ECU_PART_NUMBER_3 0x50
#define CB_MIN_ECU_PART_NUMBER_3 0x00
#define CB_MAX_ECU_PART_NUMBER_3 0xFF

#define CB_DEF_ECU_PART_NUMBER_4 0x10
#define CB_MIN_ECU_PART_NUMBER_4 0x00
#define CB_MAX_ECU_PART_NUMBER_4 0xFF

#define CB_DEF_ECU_PART_NUMBER_5 'P'
#define CB_MIN_ECU_PART_NUMBER_5 0x00
#define CB_MAX_ECU_PART_NUMBER_5 0xFF

#define CB_DEF_ECU_PART_NUMBER_6 0x00
#define CB_MIN_ECU_PART_NUMBER_6 0x00
#define CB_MAX_ECU_PART_NUMBER_6 0xFF

#define CB_DEF_ECU_PART_NUMBER_7 0x00
#define CB_MIN_ECU_PART_NUMBER_7 0x00
#define CB_MAX_ECU_PART_NUMBER_7 0xFF

#define CB_DEF_LDF_VERSION_1 0x70
#define CB_MIN_LDF_VERSION_1 0x00
#define CB_MAX_LDF_VERSION_1 0xFF

#define CB_DEF_LDF_VERSION_2 0x01
#define CB_MIN_LDF_VERSION_2 0x00
#define CB_MAX_LDF_VERSION_2 0xFF
...
const byte __far cb_EEPROMDataDefaultMinMax_PD_g[cb_NumberofEEPROMCells_PD_g][3] = {
  ...
  {CB_DEF_LINID_TRANSMISSION_01          ,CB_MIN_LINID_TRANSMISSION_01          ,CB_MAX_LINID_TRANSMISSION_01          },      /*348*/  
  {CB_DEF_SYSTEM_SUPPLIER_ID_NUMBER_1    ,CB_MIN_SYSTEM_SUPPLIER_ID_NUMBER_1    ,CB_MAX_SYSTEM_SUPPLIER_ID_NUMBER_1    },      /*349*/
  {CB_DEF_SYSTEM_SUPPLIER_ID_NUMBER_2    ,CB_MIN_SYSTEM_SUPPLIER_ID_NUMBER_2    ,CB_MAX_SYSTEM_SUPPLIER_ID_NUMBER_2    },      /*350*/
  {CB_DEF_SYSTEM_SUPPLIER_ID_NUMBER_3    ,CB_MIN_SYSTEM_SUPPLIER_ID_NUMBER_3    ,CB_MAX_SYSTEM_SUPPLIER_ID_NUMBER_3    },      /*351*/
  {CB_DEF_SYSTEM_SUPPLIER_ID_NUMBER_4    ,CB_MIN_SYSTEM_SUPPLIER_ID_NUMBER_4    ,CB_MAX_SYSTEM_SUPPLIER_ID_NUMBER_4    },      /*352*/
  {CB_DEF_SYSTEM_SUPPLIER_ID_NUMBER_5    ,CB_MIN_SYSTEM_SUPPLIER_ID_NUMBER_5    ,CB_MAX_SYSTEM_SUPPLIER_ID_NUMBER_5    },      /*353*/   
  {CB_DEF_ECU_NAME_DATA_NUMBER_1         ,CB_MIN_ECU_NAME_DATA_NUMBER_1         ,CB_MAX_ECU_NAME_DATA_NUMBER_1         },      /*354*/
  {CB_DEF_ECU_NAME_DATA_NUMBER_2         ,CB_MIN_ECU_NAME_DATA_NUMBER_2         ,CB_MAX_ECU_NAME_DATA_NUMBER_2         },      /*355*/
  {CB_DEF_ECU_NAME_DATA_NUMBER_3         ,CB_MIN_ECU_NAME_DATA_NUMBER_3         ,CB_MAX_ECU_NAME_DATA_NUMBER_3         },      /*356*/
  {CB_DEF_ECU_NAME_DATA_NUMBER_4         ,CB_MIN_ECU_NAME_DATA_NUMBER_4         ,CB_MAX_ECU_NAME_DATA_NUMBER_4         },      /*357*/
  {CB_DEF_ECU_NAME_DATA_NUMBER_5         ,CB_MIN_ECU_NAME_DATA_NUMBER_5         ,CB_MAX_ECU_NAME_DATA_NUMBER_5         },      /*358*/
  {CB_DEF_ECU_NAME_DATA_NUMBER_6         ,CB_MIN_ECU_NAME_DATA_NUMBER_6         ,CB_MAX_ECU_NAME_DATA_NUMBER_6         },      /*359*/
  {CB_DEF_ECU_NAME_DATA_NUMBER_7         ,CB_MIN_ECU_NAME_DATA_NUMBER_7         ,CB_MAX_ECU_NAME_DATA_NUMBER_7         },      /*360*/
  {CB_DEF_ECU_NAME_DATA_NUMBER_8         ,CB_MIN_ECU_NAME_DATA_NUMBER_8         ,CB_MAX_ECU_NAME_DATA_NUMBER_8         },      /*361*/
  {CB_DEF_ECU_NAME_DATA_NUMBER_9         ,CB_MIN_ECU_NAME_DATA_NUMBER_9         ,CB_MAX_ECU_NAME_DATA_NUMBER_9         },      /*362*/
  {CB_DEF_ECU_NAME_DATA_NUMBER_10        ,CB_MIN_ECU_NAME_DATA_NUMBER_10        ,CB_MAX_ECU_NAME_DATA_NUMBER_10        },      /*363*/
  {CB_DEF_ECU_NAME_DATA_NUMBER_11        ,CB_MIN_ECU_NAME_DATA_NUMBER_11        ,CB_MAX_ECU_NAME_DATA_NUMBER_11        },      /*364*/
  {CB_DEF_ECU_NAME_DATA_NUMBER_12        ,CB_MIN_ECU_NAME_DATA_NUMBER_12        ,CB_MAX_ECU_NAME_DATA_NUMBER_12        },      /*365*/
  {CB_DEF_ECU_NAME_DATA_NUMBER_13        ,CB_MIN_ECU_NAME_DATA_NUMBER_13        ,CB_MAX_ECU_NAME_DATA_NUMBER_13        },      /*366*/
  {CB_DEF_ECU_NAME_DATA_NUMBER_14        ,CB_MIN_ECU_NAME_DATA_NUMBER_14        ,CB_MAX_ECU_NAME_DATA_NUMBER_14        },      /*367*/
  {CB_DEF_ECU_NAME_DATA_NUMBER_15        ,CB_MIN_ECU_NAME_DATA_NUMBER_15        ,CB_MAX_ECU_NAME_DATA_NUMBER_15        },      /*368*/ 
  {CB_DEF_ECU_PART_NUMBER_1              ,CB_MIN_ECU_PART_NUMBER_1              ,CB_MAX_ECU_PART_NUMBER_1              },      /*369*/
  {CB_DEF_ECU_PART_NUMBER_2              ,CB_MIN_ECU_PART_NUMBER_2              ,CB_MAX_ECU_PART_NUMBER_2              },      /*370*/
  {CB_DEF_ECU_PART_NUMBER_3              ,CB_MIN_ECU_PART_NUMBER_3              ,CB_MAX_ECU_PART_NUMBER_3              },      /*371*/
  {CB_DEF_ECU_PART_NUMBER_4              ,CB_MIN_ECU_PART_NUMBER_4              ,CB_MAX_ECU_PART_NUMBER_4              },      /*372*/
  {CB_DEF_ECU_PART_NUMBER_5              ,CB_MIN_ECU_PART_NUMBER_5              ,CB_MAX_ECU_PART_NUMBER_5              },      /*373*/
  {CB_DEF_ECU_PART_NUMBER_6              ,CB_MIN_ECU_PART_NUMBER_6              ,CB_MAX_ECU_PART_NUMBER_6              },      /*374*/
  {CB_DEF_ECU_PART_NUMBER_7              ,CB_MIN_ECU_PART_NUMBER_7              ,CB_MAX_ECU_PART_NUMBER_7              },      /*375*/
  {CB_DEF_LDF_VERSION_1                  ,CB_MIN_LDF_VERSION_1                  ,CB_MAX_LDF_VERSION_1                  },      /*376*/
  {CB_DEF_LDF_VERSION_2                  ,CB_MIN_LDF_VERSION_2                  ,CB_MAX_LDF_VERSION_2                  },      /*377*/
};
...
typedef struct {
  ...
  byte IDSPARE_01 ;                /*347*/ 
  byte TRANSMISSION_01;            /*348*/
  byte System_Supplier_ID[5];      /*349,350,351,352,353*/      
  byte ECU_Name_Data[15];          /*354,355,356,357,358,359,360,361,362,363,364,365,366,367,368*/
  byte ECU_Part_Number[7];         /*369,370,371,372,373,374,375*/
  byte LDF_Version[2];             /*376,377*/
...
#define rb_TRANSMISSION_01_g                            EEPROM_Struct_PD.EEPROMStructPD.TRANSMISSION_01 
...
#define rab_System_Supplier_ID_g(a)                     (EEPROM_Struct_PD.EEPROMStructPD.System_Supplier_ID[(a)])
#define rab_ECU_Name_Data_g(a)                          (EEPROM_Struct_PD.EEPROMStructPD.ECU_Name_Data[(a)])
#define rab_ECU_Part_Number_g(a)                        (EEPROM_Struct_PD.EEPROMStructPD.ECU_Part_Number[(a)])
#define rab_LDF_File_Version(a)                         (EEPROM_Struct_PD.EEPROMStructPD.LDF_Version[(a)])
...
#define CW_E2_IDTRANSMISSION_01_ADDRESS (348)
