...
#define kLinNumberOfConfFlags         11
#define kLinNumberOfIndFlags          7

#define kLinNumberOfTxObjects         11
#define kLinNumberOfRxObjects         7
#define kLinNumberOfObjects           18
