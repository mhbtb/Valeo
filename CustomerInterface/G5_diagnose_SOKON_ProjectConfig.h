...
#define cb_INITAL_TARGET_ADDRESS_s    0x13
...
#define SYSTEM_NAMES_RLS                                       \
  {0x01,"SOKON_RS        "}, /* Rain*/                         \
  {0x04,"SOKON_LS        "}, /* Light*/                        \
  {0x05,"SOKON_RLS       "}, /* Light, Rain*/                  \
  {0x07,"SOKON_RLSS      "}, /* Light,Solar, Rain*/            \
  {0x98,"SOKON_FeuchteS  "}, /* Humidity */                    \
  {0x8A,"SOKON_FSS       "}, /* Humidity,Solar */              \
  {0x0C,"SOKON_LFS       "}, /* Humidity,Light */              \
  {0x0D,"SOKON_RLFS      "}, /* Humidity,Light,Rain */         \
  {0x0E,"SOKON_LFSS      "}, /* Humidity,Light,Solar */        \
  {0x0F,"SOKON_RLFSS     "}  /* Humidity,Light,solar,Rain */    
