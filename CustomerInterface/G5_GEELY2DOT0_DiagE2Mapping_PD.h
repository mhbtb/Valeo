#ifndef G5_GEELY_DIAGE2MAPPING_PD_H
#define G5_GEELY_DIAGE2MAPPING_PD_H
...
#define cb_NumberofEEPROMCells_PD_g (104) 
...
#define CB_DEF_INTENSITY_OVERWIPECOEF 0x28
#define CB_MIN_INTENSITY_OVERWIPECOEF 0x00
#define CB_MAX_INTENSITY_OVERWIPECOEF 0xFF

/*Rain intensity VCO_423: EEPROM thresold for idle time delay (default: 60)*/
#define CB_DEF_INTENSITY_THR_IDLETIME 0x3C
#define CB_MIN_INTENSITY_FAST_IDLETIME 0x00
#define CB_MAX_INTENSITY_FAST_IDLETIME 0xFF

/* Rain intensity VCO_423: Threshold for Signal voltage  (default: 3600) */
#define CB_DEF_THR_SIGVOLTAGEH 0x0E 
#define CB_MIN_THR_SIGVOLTAGEH 0x00
#define CB_MAX_THR_SIGVOLTAGEH 0xFF

#define CB_DEF_THR_SIGVOLTAGEL 0x10
#define CB_MIN_THR_SIGVOLTAGEL 0x00
#define CB_MAX_THR_SIGVOLTAGEL 0xFF
...
#define CW_MAX_A_FACTOR_ALS5 (word)0xBFFFU // add 20180624
...
#define CB_DEF_RSCONTROLFLAGS               0x01
...
#define CB_DEF_NAD                          0x7B
#define CB_MIN_NAD                          0x01
#define CB_MAX_NAD                          0x7E

#define CB_DEF_IDRLSS_01                    0x55//0X15-->0X55 
#define CB_MIN_IDRLSS_01                    0
#define CB_MAX_IDRLSS_01                    0xff

#define CB_DEF_IDRLSS_02                    0x20//0X20-->0X20 
#define CB_MIN_IDRLSS_02                    0
#define CB_MAX_IDRLSS_02                    0xff

#define CB_DEF_IDRLSS_03                    0xE2//0X22-->0XE2
#define CB_MIN_IDRLSS_03                    0
#define CB_MAX_IDRLSS_03                    0xff

#define CB_DEF_IDRLSS_04                    0xD8//0X18-->0XD8
#define CB_MIN_IDRLSS_04                    0
#define CB_MAX_IDRLSS_04                    0xff

#define CB_DEF_IDRLSS_05                    0xEC
#define CB_MIN_IDRLSS_05                    0
#define CB_MAX_IDRLSS_05                    0xff

#define CB_DEF_IDRLSS_06                    0x42
#define CB_MIN_IDRLSS_06                    0
#define CB_MAX_IDRLSS_06                    0xff

#ifdef HUD_FUNCTION
#define CB_DEF_HUD_FACTOR                   0x00            /***   32*Ln(x)   ***/
#define CB_MIN_HUD_FACTOR                   0x00
#define CB_MAX_HUD_FACTOR                   0xFF
#endif
...
#define CB_DEF_BCM1_LIN1_01                 0x85//0x5-->0x85
#define CB_MIN_BCM1_LIN1_01                 0
#define CB_MAX_BCM1_LIN1_01                 0xff

#define CB_DEF_BCM1_LIN1_02                 0x47//0x7-->0x47
#define CB_MIN_BCM1_LIN1_02                 0
#define CB_MAX_BCM1_LIN1_02                 0xff

#define CB_DEF_BCM1_LIN1_03                 0x97//0x17-->0x97
#define CB_MIN_BCM1_LIN1_03                 0
#define CB_MAX_BCM1_LIN1_03                 0xff

#define CB_DEF_BCM1_LIN1_04                 0x49
#define CB_MIN_BCM1_LIN1_04                 0
#define CB_MAX_BCM1_LIN1_04                 0xff

#define CB_DEF_BCM1_LIN1_05                 0xCA
#define CB_MIN_BCM1_LIN1_05                 0
#define CB_MAX_BCM1_LIN1_05                 0xff


#define CB_DEF_HUD_RESOLUTION               0x64
#define CB_MIN_HUD_RESOLUTION               0
#define CB_MAX_HUD_RESOLUTION               0xff

#define CB_DEF_HUD_VALUE               (word)0x028fU
#define CB_MIN_HUD_VALUE               (word)0x0000U
#define CB_MAX_HUD_VALUE               (word)0xFFFFU

/*Not used in NL_5 WIPER ID*/
#define CB_DEF_WWSS_01                      0xE7
...
#define CB_DEF_SCORDER12                    0x31
#define CB_MIN_SCORDER12                    0x00
#define CB_MAX_SCORDER12                    0x7F

#define CB_DEF_SCORDER3                     0x07
#define CB_MIN_SCORDER3                     0x00
#define CB_MAX_SCORDER3                     0x7F

#define CB_DEF_SCORDERMAX                   0x28
#define CB_MIN_SCORDERMAX                   0x00
#define CB_MAX_SCORDERMAX                   0x7F

#ifdef ASIC_TEST

#define CB_DEF_ASIC_FRAME_01                    0x40
#define CB_MIN_ASIC_FRAME_01                    0x00
#define CB_MAX_ASIC_FRAME_01                    0xFF

#define CB_DEF_ASIC_FRAME_02                    0x40
#define CB_MIN_ASIC_FRAME_02                    0x00
#define CB_MAX_ASIC_FRAME_02                    0xFF

#define CB_DEF_ASIC_FRAME_03                    0x40
#define CB_MIN_ASIC_FRAME_03                    0x00
#define CB_MAX_ASIC_FRAME_03                    0xFF

#define CB_DEF_ASIC_FRAME_04                    0x40
...
#define CB_DEF_AUDI_HW_PART_NUMBER_1  '0'
...
const byte __far cb_EEPROMDataDefaultMinMax_PD_g[cb_NumberofEEPROMCells_PD_g][3] = {
  ...
  {CB_DEF_EEPROM_ERASE_COUNTER           ,CB_MIN_EEPROM_ERASE_COUNTER           ,CB_MAX_EEPROM_ERASE_COUNTER           },      /*306*/
...
#endif
  {CB_DEF_ASIC_RCTR_REG                  ,CB_MIN_ASIC_RCTR_REG                  ,CB_MAX_ASIC_RCTR_REG                  },      /*334*/  /*330*/
  {CB_DEF_ASIC_RFCTR_REG                 ,CB_MIN_ASIC_RFCTR_REG                 ,CB_MAX_ASIC_RFCTR_REG                 },      /*335*/  /*331*/
  {CB_DEF_ERROR_ACTIVE_1                 ,CB_MIN_ERROR_ACTIVE_1                 ,CB_MAX_ERROR_ACTIVE_1                 },      /*336*/  /*332*/
  {CB_DEF_ERROR_ACTIVE_2                 ,CB_MIN_ERROR_ACTIVE_2                 ,CB_MAX_ERROR_ACTIVE_2                 },      /*337*/  /*333*/
  {CB_DEF_ERROR_ACTIVE_3                 ,CB_MIN_ERROR_ACTIVE_3                 ,CB_MAX_ERROR_ACTIVE_3                 },      /*338*/  /*334*/
  {CB_DEF_ERASE_COUNTER                 ,CB_MIN_ERASE_COUNTER                 ,CB_MAX_ERASE_COUNTER                    },      /*339*/  /*335*/
  {CB_DEF_ERASE_COUNTER                 ,CB_MIN_ERASE_COUNTER                 ,CB_MAX_ERASE_COUNTER                    },      /*340*/  /*336*/
  {CB_DEF_ERASE_COUNTER                 ,CB_MIN_ERASE_COUNTER                 ,CB_MAX_ERASE_COUNTER                    },      /*341*/  /*337*/
  {CB_DEF_ERASE_COUNTER                 ,CB_MIN_ERASE_COUNTER                 ,CB_MAX_ERASE_COUNTER                    },      /*342*/  /*338*/
  {CB_DEF_VARIANT_ID                     ,CB_MIN_VARIANT_ID                     ,CB_MAX_VARIANT_ID                     },      /*343*/  /*339*/
  {(byte)(CW_DEF_FUNCTION_ID&0xFF)       ,(byte)(CW_MIN_FUNCTION_ID&0xFF)       ,(byte)(CW_MAX_FUNCTION_ID&0xFF)       },      /*344*/  /*340*/
  {(byte)(CW_DEF_FUNCTION_ID>>8)         ,(byte)(CW_MIN_FUNCTION_ID>>8)         ,(byte)(CW_MAX_FUNCTION_ID>>8)         },      /*345*/  /*341*/
  {CB_DEF_ERR_DATA_01                    ,CB_MIN_ERR_DATA_01                    ,CB_MAX_ERR_DATA_01                    },      /*346*/  /*342*/
  {CB_DEF_LINID_SPARE_01                 ,CB_MIN_LINID_SPARE_01                 ,CB_MAX_LINID_SPARE_01                 },      /*347*/  /*343*/
  {CB_DEF_IDRLSS_02                      ,CB_MIN_IDRLSS_02                      ,CB_MAX_IDRLSS_02                      },      /*348*/  /*344*/
  {CB_DEF_BCM1_LIN1_02                   ,CB_MIN_BCM1_LIN1_02                   ,CB_MAX_BCM1_LIN1_02                   },      /*349*/  /*345*/
  {CB_DEF_IDRLSS_03                      ,CB_MIN_IDRLSS_03                      ,CB_MAX_IDRLSS_03                      },      /*351*/  /*346*/
  {CB_DEF_IDRLSS_04                      ,CB_MIN_IDRLSS_04                      ,CB_MAX_IDRLSS_04                      },      /*352*/  /*347*/
  {CB_DEF_IDRLSS_05                     ,CB_MIN_IDRLSS_05                      ,CB_MAX_IDRLSS_05                      },      /*353*/   /*348*/
  {CB_DEF_IDRLSS_06                     ,CB_MIN_IDRLSS_06                      ,CB_MAX_IDRLSS_06                      },      /*354*/   /*359*/
  {CB_DEF_BCM1_LIN1_03                   ,CB_MIN_BCM1_LIN1_03                   ,CB_MAX_BCM1_LIN1_03                   },      /*355*/  /*350*/
  {CB_DEF_BCM1_LIN1_04                   ,CB_MIN_BCM1_LIN1_04                   ,CB_MAX_BCM1_LIN1_04                   },      /*356*/  /*351*/
  {CB_DEF_BCM1_LIN1_05                   ,CB_MIN_BCM1_LIN1_05                   ,CB_MAX_BCM1_LIN1_05                   },      /*357*/  /*352*/  
  {CB_DEF_INTENSITY_OVERWIPECOEF         ,CB_MIN_INTENSITY_OVERWIPECOEF         ,CB_MAX_INTENSITY_OVERWIPECOEF         },               /*353*/
  {CB_DEF_INTENSITY_THR_IDLETIME         ,CB_MIN_INTENSITY_FAST_IDLETIME        ,CB_MAX_INTENSITY_FAST_IDLETIME        },               /*354*/
  {CB_DEF_THR_SIGVOLTAGEH                ,CB_MIN_THR_SIGVOLTAGEH                ,CB_MAX_THR_SIGVOLTAGEH                },               /*355*/
  {CB_DEF_THR_SIGVOLTAGEL                ,CB_MIN_THR_SIGVOLTAGEL                ,CB_MAX_THR_SIGVOLTAGEL                },               /*356*/
  {CB_DEF_SCORDER12                      ,CB_MIN_SCORDER12                      ,CB_MAX_SCORDER12                      },               /*357*/
  {CB_DEF_SCORDER3                       ,CB_MIN_SCORDER3                       ,CB_MAX_SCORDER3                       },               /*358*/
  {CB_DEF_SCORDERMAX                     ,CB_MIN_SCORDERMAX                     ,CB_MAX_SCORDERMAX                     },               /*359*/
};
...
typedef struct {
  ...
  word FunctionID_g;                 /*344,345*/   /*340,341*/
  byte IDERRDATA_01 ;                /*346*/       /*342*/
  byte IDSPARE_01 ;                  /*347*/       /*343*/
  byte IDRLSs_02;                    /*348*/       /*344*/
  byte IDBCM1_LIN1_02;          /*349*/            /*345*/
  byte IDRLSs_03;                    /*351*/       /*346*/
  byte IDRLSs_04;                    /*352*/       /*347*/
  byte IDRLSs_05;                    /*353*/       /*348*/
  byte IDRLSs_06;                    /*354*/       /*349*/
  byte IDBCM1_LIN1_03;          /*355*/            /*350*/   
  byte IDBCM1_LIN1_04;          /*356*/            /*351*/
  byte IDBCM1_LIN1_05;          /*357*/            /*352*/           
  byte RS_Intensity_OverWipeCoef;                  /*353*/
  byte RS_Intensity_Thr_IdleTime;                  /*354*/
  byte RS_Intensity_SigVoltageH;                   /*355*/
  byte RS_Intensity_SigVoltageL;                   /*356*/ 
  byte SC_ORDER12 ;                                /*357*/
  byte SC_ORDER3 ;                                 /*358*/
  byte SC_MAX ;                                    /*359*/
...
#define rb_EEPROM_Erase_Counter_g                       EEPROM_Struct_PD.EEPROMStructPD.EEPROM_Erase_Counter 
...
#define rb_IDRLSs_02_g                                  EEPROM_Struct_PD.EEPROMStructPD.IDRLSs_02 
#define rb_IDRLSs_03_g                                  EEPROM_Struct_PD.EEPROMStructPD.IDRLSs_03 
#define rb_IDRLSs_04_g                                  EEPROM_Struct_PD.EEPROMStructPD.IDRLSs_04 
#define rb_IDRLSs_05_g                                  EEPROM_Struct_PD.EEPROMStructPD.IDRLSs_05 
#define rb_IDRLSs_06_g                                  EEPROM_Struct_PD.EEPROMStructPD.IDRLSs_06 
#define rb_IDBCM1_LIN1_01_g                             EEPROM_Struct_PD.EEPROMStructPD.IDBCM1_LIN1_01
#define rb_IDBCM1_LIN1_02_g                             EEPROM_Struct_PD.EEPROMStructPD.IDBCM1_LIN1_02 
#define rb_IDBCM1_LIN1_03_g                             EEPROM_Struct_PD.EEPROMStructPD.IDBCM1_LIN1_03 
#define rb_IDBCM1_LIN1_04_g                             EEPROM_Struct_PD.EEPROMStructPD.IDBCM1_LIN1_04 
#define rb_IDBCM1_LIN1_05_g                             EEPROM_Struct_PD.EEPROMStructPD.IDBCM1_LIN1_05 
...
#define rb_SC_order1_g                                   (EEPROM_Struct_PD.EEPROMStructPD.SC_ORDER12 & 0x0F)
#define rb_SC_order2_g                                   ((EEPROM_Struct_PD.EEPROMStructPD.SC_ORDER12 & 0xF0) >> 4)
#define rb_SC_order3_g                                   EEPROM_Struct_PD.EEPROMStructPD.SC_ORDER3
#define rb_SC_max_g                                     EEPROM_Struct_PD.EEPROMStructPD.SC_MAX
#define rb_SC_debounce_g                                (2 * rb_SC_max_g)
/*20191224_Zhiyuan HU_Jiri*/
...
#define rb_Intensity_OverWipeCoef_g                     EEPROM_Struct_PD.EEPROMStructPD.RS_Intensity_OverWipeCoef
#define rb_Intensity_Thr_IdleTime_g                     EEPROM_Struct_PD.EEPROMStructPD.RS_Intensity_Thr_IdleTime
#define rb_RS_Intensity_SigVoltageH_g                   EEPROM_Struct_PD.EEPROMStructPD.RS_Intensity_SigVoltageH                     
#define rb_RS_Intensity_SigVoltageL_g                   EEPROM_Struct_PD.EEPROMStructPD.RS_Intensity_SigVoltageL  
