...
#define cb_NumberofEEPROMCells_PD_g (93+4)  
...
const byte __far cb_EEPROMDataDefaultMinMax_PD_g[cb_NumberofEEPROMCells_PD_g][3] = {
  ...
  {CB_DEF_INTENSITY_OVERWIPECOEF         ,CB_MIN_INTENSITY_OVERWIPECOEF         ,CB_MAX_INTENSITY_OVERWIPECOEF         },      /*349*/
  {CB_DEF_INTENSITY_THR_IDLETIME         ,CB_MIN_INTENSITY_FAST_IDLETIME        ,CB_MAX_INTENSITY_FAST_IDLETIME        },      /*350*/
  {CB_DEF_THR_SIGVOLTAGEH                ,CB_MIN_THR_SIGVOLTAGEH                ,CB_MAX_THR_SIGVOLTAGEH                },      /*351*/
  {CB_DEF_THR_SIGVOLTAGEL                ,CB_MIN_THR_SIGVOLTAGEL                ,CB_MAX_THR_SIGVOLTAGEL                },      /*352*/ 
};
...
typedef struct {
  ...
  byte IDSPARE_01 ;                /*347*/ 
  byte IDRLSs_02;                     /*348*/
  byte RS_Intensity_OverWipeCoef;               /*349*/
  byte RS_Intensity_Thr_IdleTime;               /*350*/
  byte RS_Intensity_SigVoltageH;                /*351*/
  byte RS_Intensity_SigVoltageL;                /*352*/
