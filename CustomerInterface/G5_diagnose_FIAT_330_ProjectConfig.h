...
#define cb_INITAL_TARGET_ADDRESS_s      0x09
...
#define cb_SOFTWARESTAND_3_g  '2'
#define cb_SWSTAND_ADD_ON_g   'A'      /* increase for subversion can be read out at adress 58*/
#endif
...
/* {ID  ,   Name}  at least one entry should exist*/          \
  {0x01,"RS_FCA2         "}, /* Rain*/                         \
  {0x04,"LS_FCA2         "}, /* Light*/                        \
  {0x05,"RLS_FCA2        "}, /* Light, Rain*/                  \
  {0x07,"RLSS_FCA2       "}, /* Light,Solar, Rain*/            \
  {0x08,"HS_FCA2         "}, /* Humidity */                    \
  {0x0C,"LHS_FCA2        "}, /* Humidity,Light */              \
  {0x0D,"RLHS_FCA2       "}, /* Humidity,Light,Rain */         \
  {0x0E,"LHSS_FCA2       "}, /* Humidity,Light,Solar */        \
  {0x0F,"RLHSS_FCA2      "}  /* Humidity,Light,solar,Rain */   
