...
#define cb_SOFTWARESTAND_3_g            '9'
#define cb_SWSTAND_ADD_ON_WITH_RAIN_g   'E'      /* increase for subversion can be read out at address 80 */
