...
#define _SUPPORTLINDATADUMP_
#define cb_INITAL_TARGET_ADDRESS_s    0x15
...
/* {ID  ,   Name}  at least one entry should exist*/           \
  {0x01,"NL5_RS          "}, /* Rain*/                         \
  {0x04,"NL5_LS          "}, /* Light*/                        \
  {0x05,"NL5_RLS         "}, /* Light, Rain*/                  \
  {0x07,"NL5_RLSS        "}, /* Light,Solar, Rain*/            \
  {0x98,"NL5_FOGS        "}, /* Humidity */                    \
  {0x8A,"NL5_FSS         "}, /* Humidity,Solar */              \
  {0x0C,"NL5_LFS         "}, /* Humidity,Light */              \
  {0x0D,"NL5_RLFS        "}, /* Humidity,Light,Rain */         \
  {0x0E,"NL5_LFSS        "}, /* Humidity,Light,Solar */        \
  {0x0F,"NL5_RLFSS       "}  /* Humidity,Light,solar,Rain */   
