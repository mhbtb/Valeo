...
#define SYSTEM_NAMES_RLS                                       \
  {0x01,"Chery_T18_RS    "}, /* Rain*/                         \
  {0x04,"Chery_T18_LS    "}, /* Light*/                        \
  {0x05,"Chery_T18_RLS   "}, /* Light, Rain*/                  \
  {0x07,"Chery_T18_RLSS  "}, /* Light,Solar, Rain*/            \
  {0x98,"Chery_T18_F     "}, /* Humidity */                    \
  {0x8A,"Chery_T18_FSS   "}, /* Humidity,Solar */              \
  {0x0C,"Chery_T18_LFS   "}, /* Humidity,Light */              \
  {0x0D,"Chery_T18_RLFS  "}, /* Humidity,Light,Rain */         \
  {0x0E,"Chery_T18_LFSS  "}, /* Humidity,Light,Solar */        \
  {0x0F,"Chery_T18_RLFSS "}  /* Humidity,Light,solar,Rain */    
