...
#define cb_NumberofEEPROMCells_PD_g 102  
...
/*20190718_Standby_Threshold*/
#define CB_DEF_STANDBYTHRESHOLD                    0x05
#define CB_MIN_STANDBYTHRESHOLD                    0x00
#define CB_MAX_STANDBYTHRESHOLD                    0xFF
/*20190718_Standby_Threshold*/


/*20190718_Standby_to_Prestandby_Initialize_Time*/
#define CB_DEF_STANDBYTOPRESTANDBYINITIALIZETIME                    0x19
#define CB_MIN_STANDBYTOPRESTANDBYINITIALIZETIME                    0x00
#define CB_MAX_STANDBYTOPRESTANDBYINITIALIZETIME                    0xFF
/*20190718_Standby_to_Prestandby_Initialize_Time*/
#ifdef _DIAGNOSE_c_
#define EXTERN /**/
...
const byte __far cb_EEPROMDataDefaultMinMax_PD_g[cb_NumberofEEPROMCells_PD_g][3] = {
  ...
  {CB_DEF_INTENSITY_OVERWIPECOEF         ,CB_MIN_INTENSITY_OVERWIPECOEF         ,CB_MAX_INTENSITY_OVERWIPECOEF         },      /*348*/
  {CB_DEF_INTENSITY_THR_IDLETIME         ,CB_MIN_INTENSITY_FAST_IDLETIME        ,CB_MAX_INTENSITY_FAST_IDLETIME        },      /*349*/
  {CB_DEF_THR_SIGVOLTAGEH                ,CB_MIN_THR_SIGVOLTAGEH                ,CB_MAX_THR_SIGVOLTAGEH                },      /*350*/
  {CB_DEF_THR_SIGVOLTAGEL                ,CB_MIN_THR_SIGVOLTAGEL                ,CB_MAX_THR_SIGVOLTAGEL                },      /*351*/ 
  {CB_DEF_STANDBYTHRESHOLD               ,CB_MIN_STANDBYTHRESHOLD               ,CB_MAX_STANDBYTHRESHOLD               },      /*352*/
  {CB_DEF_STANDBYTOPRESTANDBYINITIALIZETIME,CB_MIN_STANDBYTOPRESTANDBYINITIALIZETIME,CB_MAX_STANDBYTOPRESTANDBYINITIALIZETIME},/*353*/
  {50,0,255},/*354*/
  {CB_DEF_SCORDER12                      ,CB_MIN_SCORDER12                      ,CB_MAX_SCORDER12                      },      /*355*/
  {CB_DEF_SCORDER3                       ,CB_MIN_SCORDER3                       ,CB_MAX_SCORDER3                       },      /*356*/
  {CB_DEF_SCORDERMAX                     ,CB_MIN_SCORDERMAX                     ,CB_MAX_SCORDERMAX                     },      /*357*/
};
...
typedef struct {
  ...
  byte RS_Intensity_OverWipeCoef;               /*348*/
  byte RS_Intensity_Thr_IdleTime;               /*349*/
  byte RS_Intensity_SigVoltageH;                /*350*/
  byte RS_Intensity_SigVoltageL;                /*351*/
  byte Standby_threshold;/*352*/
  byte PreStandby_Init_time;/*353*/
  byte cb_THRES_RSACTION_mgg;/*354*/
  byte SC_ORDER12 ;                   /*355*/
  byte SC_ORDER3 ;                    /*356*/
  byte SC_MAX ;                       /*357*/
...
#define cb_THRES_RSACTION_mg				EEPROM_Struct_PD.EEPROMStructPD.cb_THRES_RSACTION_mgg
#define PreStandby_Init_time_g                          EEPROM_Struct_PD.EEPROMStructPD.PreStandby_Init_time
#define Standby_threshold_g                             EEPROM_Struct_PD.EEPROMStructPD.Standby_threshold
