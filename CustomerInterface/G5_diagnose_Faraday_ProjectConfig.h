...
#define cb_SOFTWARESTAND_3_g            '4'
#define cb_SWSTAND_ADD_ON_WITH_RAIN_g   'B'      /* increase for subversion can be read out at address 80 */
...
/* {ID  ,   Name}  at least one entry should exist*/           \
  {0x01,"FARADAY_RS      "}, /* Rain*/                         \
  {0x04,"FARADAY_LS      "}, /* Light*/                        \
  {0x05,"FARADAY_RLS     "}, /* Light, Rain*/                  \
  {0x07,"FARADAY_RLSS    "}, /* Light,Solar, Rain*/            \
  {0x98,"FARADAY_FeuchteS"}, /* Humidity */                    \
  {0x8A,"FARADAY_FSS     "}, /* Humidity,Solar */              \
  {0x0C,"FARADAY_LFS     "}, /* Humidity,Light */              \
  {0x0D,"FARADAY_RLFS    "}, /* Humidity,Light,Rain */         \
  {0x0E,"FARADAY_LFSS    "}, /* Humidity,Light,Solar */        \
  {0x0F,"FARADAY_RLFSS   "}  /* Humidity,Light,solar,Rain */   
