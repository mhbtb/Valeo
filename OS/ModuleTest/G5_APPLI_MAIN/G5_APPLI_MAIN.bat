...
echo environment build G5_APPLI_MAIN.env >> commands.tmp
echo /E:G5_APPLI_MAIN tools script run G5_APPLI_MAIN.tst >> commands.tmp
echo /E:G5_APPLI_MAIN execute batch >> commands.tmp
echo /E:G5_APPLI_MAIN reports custom management G5_APPLI_MAIN_management_report.html >> commands.tmp
