      ...
      && (rb_WDG_BusTaskCounter_g == cb_WDGCALLCOUNTERCYCLE_mg)       /*Bus Task called 6 Times?*/
        &&(rb_WDG_SCITaskCounter_g == cb_WDGCALLCOUNTERCYCLE_mg)      /* SCI- counter */
          &&(rb_WDG_LVITaskCounter_g == cb_WDGCALLCOUNTERCYCLE_mg)      /* SCI- counter */
            /*Lightsensor and Rainsensor Task called correct?*/
            
            &&(((cb_WDGCALLCOUNTERCYCLE_mg == rb_WDG_LightsensorTaskCounter_g)
#ifndef _NO_RAIN_
                &&(cb_WDGCALLCOUNTERCYCLE_mg == rb_WDG_RainsensorTaskCounter_g)
#endif /*_NO_RAIN_*/
               )
               ||(CASE_ASIC_CNT_MD_STANDBY == rb_ASIC_ControlMode_g))
