...
byte egdeVal;
byte newSpeedOut;
#if (defined (HAITEC) || defined (FOTON_S700) || defined (BRILLIANCE_M8X) || defined (BAICYX_G20) || defined (CTCS_M31T) || defined (BAICYX_H50) || defined(ZOTYE_A40) || defined(Zoety_A10)  || defined(CHJ_M01) || defined(FARADAY) || defined(GREAT_WALL_CH071) || defined(ZOTYE_B01_NEW) || defined(BYTON) ||defined(SOKON) || defined(BYD_HC))
